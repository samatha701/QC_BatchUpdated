...
public class InternalTfAndCashManagement extends QCStore{
	...
	public static void internaltf(String SSN,String AppURL) throws InterruptedException, AWTException{
			...
			{		
				...
				if(SSN.equals(RegSSN))
				{
					...
					String ESign_CheckNbr=TestData.getCellData(sheetName,"ChkAcctNumber",row);
				...
				//List<WebElement>  rows = driver.findElements(By.xpath("/html/body/form/table/tbody/tr/td/table/tbody/tr[1]/td/table/tbody/tr[2]/td/table/tbody/tr/td/table/tbody/tr[3]/td/table/tbody/tr")); 
					...
					//for(int i=4;i<=n;i++){
						...
						String Checknumber=driver.findElement(By.xpath("/html/body/form/table/tbody/tr/td/table/tbody/tr[1]/td/table/tbody/tr[2]/td/table/tbody/tr/td/table/tbody/tr[3]/td/table/tbody/tr[6]/td[2]")).getText();
						...
						if(Checknumber.contains(ESign_CheckNbr)){
							...
							driver.findElement(By.xpath("//*[@id='ILPCKPaymentChecks']")).click();
							...
							driver.findElement(By.xpath("/html/body/form/table/tbody/tr/td/table/tbody/tr[1]/td/table/tbody/tr[2]/td/table/tbody/tr/td/table/tbody/tr[3]/td/table/tbody/tr[6]/td[5]/select")).sendKeys("Manual");
							//driver.findElement(By.name("ILPCKpayDispRepresentmentType")).sendKeys("Manual");
							test.log(LogStatus.PASS, "check selected as manual ");
							//driver.findElement(By.xpath("/html/body/form/table/tbody/tr/td/table/tbody/tr[1]/td/table/tbody/tr[2]/td/table/tbody/tr/td/table/tbody/tr[3]/td/table/tbody/tr[6]/td[5]/input")).click();
