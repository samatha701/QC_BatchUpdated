...
public class VQCClearMenu extends QCStore {
	public static void clearMenu(String SSN,String AppURL)
	{
		try{
			int lastrow=TestData.getLastRow((Vprop.getProperty("Clear")));
			String sheetName=Vprop.getProperty("Clear");
			...
			for(String winHandle : driver.getWindowHandles()){
				  ...
				  if(ProductID.equals(Vprop.getProperty("PDL")))
					 {
				    driver.findElement(By.xpath(" /html/body/form[1]/table/tbody/tr/td/table/tbody/tr/td/table[2]/tbody/tr[7]/td[2]/table/tbody/tr/td/table/tbody/tr[4]/td[11]/input[1]")).click();
				    test.log(LogStatus.PASS, "Clicked on Go button under Loans section");
				    }
				    if(ProductID.equals(Vprop.getProperty("TLP")))
					 {
				    	driver.findElement(By.xpath("/html/body/form[1]/table/tbody/tr/td/table/tbody/tr/td/table[2]/tbody/tr[7]/td[2]/table/tbody/tr/td/table/tbody/tr[4]/td[13]/input")).click();
					 }
				    
				   
				    if(ProductID.equals(Vprop.getProperty("LOC")))
					 {
					   ...
					   driver.switchTo().defaultContent();
						...
						if(ESign_CollateralType.equalsIgnoreCase("CHECK"))
						{
							Actions action = new Actions(driver);  
							 ...
							 Thread.sleep(2000);
							 WebElement pdl=driver.findElement(locator(Vprop.getProperty("deposite_menu_pdl")));
							 action.moveToElement(pdl).build().perform();
							 test.log(LogStatus.PASS, " Mouse hover on payday loan menu");
							 Thread.sleep(3000);
							 driver.findElement(locator(Vprop.getProperty("deposite_clear_menu"))).click();
							 ...
							 driver.findElement(locator(Vprop.getProperty("deposite_menu_submit"))).click();
						...
						{
							Actions action = new Actions(driver);  
							 WebElement collateral=driver.findElement(locator(Vprop.getProperty("ACH")));
							 action.moveToElement(collateral).build().perform();
							 test.log(LogStatus.PASS, " Mouse hover on ACH menu");
							 Thread.sleep(2000);
							 WebElement pdl=driver.findElement(locator(Vprop.getProperty("deposit_ach_pdl")));
							 action.moveToElement(pdl).build().perform();
							 test.log(LogStatus.PASS, " Mouse hover on payday loan menu");
							 Thread.sleep(3000);
							 driver.findElement(locator(Vprop.getProperty("ACH_clear"))).click();
							 test.log(LogStatus.PASS, " click on clear menu");
							 Thread.sleep(2000);
							 driver.switchTo().defaultContent();
							 driver.switchTo().frame("mainFrame");
