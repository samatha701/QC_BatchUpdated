...
public class SLOCPayments extends QCStore{
	...
	{	
		...
		{	
			...
			{	
				...
				Thread.sleep(500);	
				if(TxnType.equalsIgnoreCase("Payment")){
				...
				if(TxnType.equalsIgnoreCase("PayOff"))
				{
					if(TenderType.equalsIgnoreCase("Cash")){
						
						driver.findElement(By.name("tenderType")).sendKeys(TenderType);
						test.log(LogStatus.PASS, "Tender Type is :"+TenderType);
						String payoffamt=driver.findElement(By.name("payOffAmount")).getAttribute("value");
						driver.findElement(By.name("tenderAmount")).sendKeys( payoffamt);
						test.log(LogStatus.PASS, "TenderAmount is :"+ payoffamt);	
					}
				}
				...
				Thread.sleep(2000);//Ok
				try{
				if(driver.findElement(By.name("Ok")).isDisplayed()||driver.findElement(By.name("YES")).isDisplayed()||driver.findElement(By.name("Yes")).isDisplayed()||driver.findElement(By.name("No")).isDisplayed())
				{
				test.log(LogStatus.PASS, "<FONT color=green style=Arial>Payment transaction is successfully");
				}
				else{
					test.log(LogStatus.INFO, "<FONT color=green style=Arial>Payment transaction is successfully");
				}
				}
				catch(Exception e){
					test.log(LogStatus.INFO, "<FONT color=green style=Arial>Payment transaction is successfully");
   ...
   public static void fullPayment (String SSN,String AppURL) throws Exception
	{	
		test.log(LogStatus.INFO, "******************Performing  payment ******************");
		...
		{	
			...
			{	
				...
				test.log(LogStatus.PASS, "Clicked on Go button ");
				Thread.sleep(500);
				if(Scenario.equalsIgnoreCase("LocPayment"))
				{
					if(TenderType.equalsIgnoreCase("Cash")){
						
						 driver.findElement(By.name("requestBean.tenderType")).sendKeys(TenderType);
							test.log(LogStatus.PASS, "Tender Type is :"+TenderType);
							String payamt=driver.findElement(By.name("loadedAmt")).getAttribute("value");
						    driver.findElement(By.name("requestBean.tenderAmt")).sendKeys( payamt);
							test.log(LogStatus.PASS, "TenderAmount is :"+ payamt);	
					}
				}
	            ...
	            driver.findElement(By.name("requestBean.tenderType")).sendKeys(TenderType);
				test.log(LogStatus.PASS, "Tender Type is :"+TenderType);
				String payamt=driver.findElement(By.name("requestBean.paymentAmt")).getAttribute("value");
			    driver.findElement(By.name("requestBean.tenderAmt")).sendKeys( payamt);
				test.log(LogStatus.PASS, "TenderAmount is :"+ payamt);	
