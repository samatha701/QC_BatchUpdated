...
public class QCPaymentforDraw extends QCStore
{

	public static void paymentDraw(String SSN,String AppURL) throws Exception
	{
		int i;
		for(i=0;i<3;i++)
		{
	...
	try{
			...
			{		
				...
				if(SSN.equals(RegSSN))
				{
					...
					driver.findElement(By.name("requestBean.tenderAmt")).sendKeys("100");
					test.log(LogStatus.PASS, "Payment amount entered as : 100");	
