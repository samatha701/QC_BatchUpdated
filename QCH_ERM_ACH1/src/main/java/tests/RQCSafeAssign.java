...
public class RQCSafeAssign extends QCStore{
	public static void safeAssign(String SSN,String AppURL)
	{
		...
		//	ExcelNew TestData = new ExcelNew(System.getProperty("user.dir")+Rprop.getProperty("QC_Store_NewLoan_Test_data_sheet_path")+FileName+".xls");  		 
				...
				{		
						...
						//driver.findElement(locator(Rprop.getProperty("safe_assign_assign_link"))).click();
						...
						try{
							Thread.sleep(4000);
							//driver.findElement(locator(Rprop.getProperty("safe_click_somewhere"))).click();
							driver.findElement(By.xpath("/html/body/form/table/tbody/tr/td/table/tbody/tr/td/table/tbody/tr[2]/td/b")).click();
							//driver.findElement(locator(Rprop.getProperty("safe_assign_next"))).click();
							 Thread.sleep(500);
							...
							try{
								Thread.sleep(5000);
								//driver.findElement(locator(Rprop.getProperty("safe_assign_yes_btn"))).click();
