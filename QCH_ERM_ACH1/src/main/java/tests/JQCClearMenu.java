...
public class JQCClearMenu extends QCStore {
					   ...
					   driver.switchTo().defaultContent();
						...
						if(ESign_CollateralType.equalsIgnoreCase("CHECK"))
						{
							Actions action = new Actions(driver);  
							 ...
							 Thread.sleep(3000);
							 driver.findElement(locator(Jprop.getProperty("deposite_clear_menu"))).click();
						...
						else if(ESign_CollateralType.equalsIgnoreCase("ACH"))
						{
							Actions action = new Actions(driver);  
							 ...
							 test.log(LogStatus.PASS, " Mouse hover on payday loan menu");
							 Thread.sleep(3000);
							 driver.findElement(locator(Jprop.getProperty("ACH_clear"))).click();
							 test.log(LogStatus.PASS, " click on clear menu");
							 Thread.sleep(2000);
							 driver.switchTo().defaultContent();
							 driver.switchTo().frame("mainFrame");
