...
public class VQCCSRBankruptcy extends QCStore {
				...
				for (int row = 2; row <= lastrow; row++) {
					...
					if (SSN.equals(RegSSN)) {
					    ...
					    for(String winHandle : driver.getWindowHandles()){
						    ...
						    //loan_number= driver.findElement(locator(Vprop.getProperty("csr_loan_nbr"))).getText();
						    ...
						    //NextDueDate= driver.findElement(locator(Vprop.getProperty("csr_due_date"))).getText();
