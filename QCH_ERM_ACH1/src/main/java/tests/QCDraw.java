...
public class QCDraw extends QCStore
{

	public static void draw(String SSN,String AppURL) throws Exception
	{
		int i;
		for(i=0;i<3;i++)
		{
...
break;
					...
					test.log(LogStatus.INFO, "Draw process is initiated again due to Application sync issue");
		...
		if(i==3)
		{
			test.log(LogStatus.FAIL, " Draw is failed");
