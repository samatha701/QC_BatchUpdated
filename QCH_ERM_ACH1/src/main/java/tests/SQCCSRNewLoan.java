...
public class SQCCSRNewLoan extends QCStore{
		...
		{	
			...
			{		
						...
						if(driver.findElement(By.id("LoanButtonId")).isEnabled())
				{
					...
					count=0;							//*[@id="riskViewBdy"]/table[3]/tbody/tr[1]/td/table/tbody/tr[3]/td/table/tbody/tr[4]/td[2]/input
...
public static void LOC() throws InterruptedException
{
	...
	{					
		rnum=rnum+1;
		if(State.equals("KS")){					//*[@id="riskViewBdy"]/table[3]/tbody/tr[1]/td/table/tbody/tr[3]/td/table/tbody/tr[4]/td[2]/input
	...
	test.log(LogStatus.PASS, "Clicked on loan button");
		...
		{	
			...
			driver.findElement(By.xpath("//*[@id='errorMessage']/form[1]/table[1]/tbody/tr[2]/td/table/tbody/tr[3]/td/table[1]/tbody/tr[18]/td[2]/div[1]/input[3]")).click();
			test.log(LogStatus.PASS, "Clicked on add card button ");
			Thread.sleep(30000);
			driver.findElement(By.name("advanceRequestBean.disbAmtFirst")).sendKeys(LOCamount2);			
			test.log(LogStatus.PASS, "Disb amount enterd  as "+LOCamount2);
