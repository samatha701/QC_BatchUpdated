...
public class JQCRefinance_CABPayment extends QCStore {
	public static void CABPayment(String SSN,String AppURL)
	{
		try{
			...
			{		
		       ...
		       Thread.sleep(4000);
				...
				Thread.sleep(5000);		
					...
					driver.findElement(By.xpath("//input[@name='advanceRequestBean.ccmoNbrFirst' and @type='text']")).sendKeys(ChkgAcctNbr);
					test.log(LogStatus.PASS, "Enter CC/MO Nbr "+ChkgAcctNbr);
					...
					test.log(LogStatus.PASS, "Entered tender amount as  :"+paymentamount);
						...
						driver.findElement(By.name("requestBean.password")).sendKeys(PIN);
							...
							test.log(LogStatus.PASS, "<FONT color=green style=Arial>"+ESign_CollateralType+ "Refinance Cashiers Check from CSR is successfull");
							 test.log(LogStatus.PASS, "**********************************************");	
							}else{
								
								test.log(LogStatus.INFO, "<FONT color=green style=Arial>"+ESign_CollateralType+ "Refinance Cashiers Check from CSR is successfull");
								 test.log(LogStatus.PASS, "**********************************************");
							}					
