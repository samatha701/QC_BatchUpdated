...
public class VQCDepositMenu_1 extends QCStore{
				...
				{		
			       ...
			       Thread.sleep(4000);
					...
					test.log(LogStatus.PASS, "Clicked on Go button under search results");
					     ...
					     String loan_nbr= driver.findElement(locator(Vprop.getProperty("loan_nbr"))).getText();
						  test.log(LogStatus.PASS, "Loan Number is" + loan_nbr);
						   
						   driver.findElement(locator(Vprop.getProperty("clear_go"))).click();
						   ...
						   driver.switchTo().defaultContent();
							...
							if(ESign_CollateralType.equalsIgnoreCase("ACH"))
							{
								driver.findElement(By.linkText("ACH")).click();
								 ...
								 driver.findElement(locator(Vprop.getProperty("deposit_ach_ilp"))).click();
								 test.log(LogStatus.PASS, "Clicked on Installment Loan");
							 Thread.sleep(2000);
							 driver.findElement(locator(Vprop.getProperty("deposit_ilp_ach_deposit"))).click();
							 ...
							 driver.switchTo().defaultContent();
							    driver.switchTo().frame("mainFrame");
							    driver.switchTo().frame("main");
							 driver.findElement(locator(Vprop.getProperty("deposit_loan_nbr"))).sendKeys(loan_nbr);
							 test.log(LogStatus.PASS, "Entered Loan number as "+ loan_nbr);
							 driver.findElement(locator(Vprop.getProperty("ACH_submit"))).click();
							 test.log(LogStatus.PASS, "Clicked on Submit button ");
							 driver.findElement(locator(Vprop.getProperty("deposit_ilp_deposit_type"))).sendKeys(RepresentmentType);
							 test.log(LogStatus.PASS, "Selected "+ RepresentmentType);
							 driver.findElement(locator(Vprop.getProperty("deposit_check_box"))).click();
							...
							if(ESign_CollateralType.equalsIgnoreCase("CHECK"))
							{
								 ...
								 WebElement collateral=driver.findElement(locator(Vprop.getProperty("deposite_collateral_check")));
								 action.moveToElement(collateral).build().perform();
								 test.log(LogStatus.PASS, " Mouse hover on collateral check menu");
								 Thread.sleep(2000);
								 WebElement pdl=driver.findElement(locator(Vprop.getProperty("deposit_check_ilp")));
								 action.moveToElement(pdl).build().perform();
								 test.log(LogStatus.PASS, " Mouse hover on Installment loan menu");
								 Thread.sleep(3000);
								 driver.findElement(locator(Vprop.getProperty("deposit_ilp_deposit"))).click();
								 test.log(LogStatus.PASS, " click on deposite menu");
								 Thread.sleep(2000);
								 driver.switchTo().defaultContent();
								 driver.switchTo().frame("mainFrame");
								 driver.switchTo().frame("main");
								 driver.findElement(locator(Vprop.getProperty("deposite_menu_loannbr"))).sendKeys(loan_nbr);
								 test.log(LogStatus.PASS, "Entered loan number as "+loan_nbr);	
								 Thread.sleep(1000);
								 driver.findElement(locator(Vprop.getProperty("ACH_submit"))).click();
								 test.log(LogStatus.PASS, "Clicked on submit button");					
							...
							{
								Actions action = new Actions(driver);  
								 WebElement dc=driver.findElement(locator(Vprop.getProperty("DC")));
								 action.moveToElement(dc).build().perform();
								 test.log(LogStatus.PASS, " Mouse hover on collateral Debit Card menu");
								 Thread.sleep(2000);
								 WebElement pdl=driver.findElement(locator(Vprop.getProperty("DC_ilp")));
								 action.moveToElement(pdl).build().perform();
								 test.log(LogStatus.PASS, " Mouse hover on Installment loan menu");
								 Thread.sleep(3000);
								 driver.findElement(locator(Vprop.getProperty("DC_ilp_deposite"))).click();
