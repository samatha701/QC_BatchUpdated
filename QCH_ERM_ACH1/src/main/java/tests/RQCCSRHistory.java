	 ...
	 //ACH collateral details from sheet
			 ...
			 //Validations
					...
					/*	String loan_balance_inf_principal_bal= driver.findElement(locator(Rprop.getProperty("loan_balance_inf_principal_bal"))).getText();
						...
						String loan_account_inf_product_name= driver.findElement(locator(Rprop.getProperty("loan_account_inf_product_name"))).getText();
						...
						String loan_account_inf_loc_amount= driver.findElement(locator(Rprop.getProperty("loan_account_inf_loc_amount"))).getText();
						...
						String loan_account_inf_loan_date= driver.findElement(locator(Rprop.getProperty("loan_account_inf_loan_date"))).getText();
						...
						String loan_account_inf_available_credit= driver.findElement(locator(Rprop.getProperty("loan_account_inf_available_credit"))).getText();
...
//Loan paid to date summary
						String loan_paid_summary_principal_paid_date= driver.findElement(locator(Rprop.getProperty("loan_paid_summary_principal_paid_date"))).getText();
						String loan_paid_summary_fee_paid_date= driver.findElement(locator(Rprop.getProperty("loan_paid_summary_fee_paid_date"))).getText();
						String loan_paid_summary_return_paid_date= driver.findElement(locator(Rprop.getProperty("loan_paid_summary_return_paid_date"))).getText();
						String loan_paid_summary_late_paid_date= driver.findElement(locator(Rprop.getProperty("loan_paid_summary_late_paid_date"))).getText();
						//String loan_paid_summary_total_paid_amt= driver.findElement(locator(Rprop.getProperty("loan_paid_summary_total_paid_date"))).getText();
					...
					/*	String loc_history_transaction_test= driver.findElement(locator(Rprop.getProperty("loc_history_transaction"))).getText();
						String loc_history_tendertype_test= driver.findElement(locator(Rprop.getProperty("loc_history_tendertype"))).getText();
						String loc_history_Tran_Amt_test= driver.findElement(locator(Rprop.getProperty("loc_history_Tran_Amt"))).getText();
						String loc_history_adv_Amt_test= driver.findElement(locator(Rprop.getProperty("loc_history_adv_Amt"))).getText();
						String loc_history_Int_Amt_test= driver.findElement(locator(Rprop.getProperty("loc_history_Int_Amt"))).getText();
						String loc_history_Lien_Amt_test= driver.findElement(locator(Rprop.getProperty("loc_history_Lien_Amt"))).getText();
						String loc_history_LateFee_Amt_test= driver.findElement(locator(Rprop.getProperty("loc_history_LateFee_Amt"))).getText();*/
							...
							String loc_history_Stmt_Nbr_test= driver.findElement(By.xpath("//*[@id='statementsGeneratedTable']/tbody/tr["+m+"]/td[1]")).getText();
							  //String loc_history_Stmt_Nbr_test= driver.findElement(locator(Rprop.getProperty("loc_history_Stmt_Nbr"))).getText();
						...
						//String loc_history_Stmt_Nbr_test= driver.findElement(locator(Rprop.getProperty("loc_history_Stmt_Nbr"))).getText();
						/*String loc_history_Stmt_Date_test= driver.findElement(locator(Rprop.getProperty("loc_history_Stmt_Date"))).getText();
						String loc_history_Min_Payment_Amt_test= driver.findElement(locator(Rprop.getProperty("loc_history_Min_Payment_Amt"))).getText();
						String loc_history_Payment_Due_Date_test= driver.findElement(locator(Rprop.getProperty("loc_history_Payment_Due_Date"))).getText();
						String loc_history_New_Balance_test= driver.findElement(locator(Rprop.getProperty("loc_history_New_Balance"))).getText();
						String loc_history_Previous_Balance_test= driver.findElement(locator(Rprop.getProperty("loc_history_Previous_Balance"))).getText();
						String loc_history_Paid_Flag_test= driver.findElement(locator(Rprop.getProperty("loc_history_Paid_Flag"))).getText();
						String loc_history_Capitalization_Interest_test= driver.findElement(locator(Rprop.getProperty("loc_history_Capitalization_Interest"))).getText();
						String loc_history_Statement_Closing_Date_test= driver.findElement(locator(Rprop.getProperty("loc_history_Statement_Closing_Date"))).getText();*/
						
						String loan_status_inf_latest_payment_date= driver.findElement(locator(Rprop.getProperty("loan_status_inf_latest_payment_date"))).getText();
						String loan_account_inf_min_pay_amt= driver.findElement(locator(Rprop.getProperty("loan_account_inf_min_pay_amt"))).getText();
						String loan_paid_summary_total_paid_amt= driver.findElement(locator(Rprop.getProperty("loan_paid_summary_total_paid_amt"))).getText();
						String loan_paid_summary_repo_fee_paid=driver.findElement(locator(Rprop.getProperty("loan_paid_summary_repo_fee_paid"))).getText();
						
						//Loan Balance Summary
						String loan_balance_inf_Earned_and_unpaid_interest= driver.findElement(locator(Rprop.getProperty("loan_balance_inf_Earned_and_unpaid_interest"))).getText();
						String loan_balance_inf_Return_Fee_Due= driver.findElement(locator(Rprop.getProperty("loan_balance_inf_Return_Fee_Due"))).getText();
						String loan_balance_inf_Late_Fee_Due= driver.findElement(locator(Rprop.getProperty("loan_balance_inf_Late_Fee_Due"))).getText();
						String loan_balance_inf_Pay_Off_Amt= driver.findElement(locator(Rprop.getProperty("loan_balance_inf_Pay_Off_Amt"))).getText();
						String loan_balance_inf_Past_Due_Amt= driver.findElement(locator(Rprop.getProperty("loan_balance_inf_Past_Due_Amt"))).getText();
						String loan_balance_inf_Remaining_Current_Payment_Amount= driver.findElement(locator(Rprop.getProperty("loan_balance_inf_Remaining_Current_Payment_Amount"))).getText();
						String loan_balance_inf_Remaining_Min_Payment_Amount= driver.findElement(locator(Rprop.getProperty("loan_balance_inf_Remaining_Min_Payment_Amount"))).getText();
						String loan_balance_inf_Statement_Payment_Amount=driver.findElement(locator(Rprop.getProperty("loan_balance_inf_Statement_Payment_Amount"))).getText();
						String loan_balance_inf_Current_Principal_Balance=driver.findElement(locator(Rprop.getProperty("loan_balance_inf_Current_Principal_Balance"))).getText();
						
						//cust documetn details
/*						String cust_doc_total_amount= driver.findElement(locator(Rprop.getProperty("cust_doc_total_amount"))).getText();
						String cust_doc_adv_amount= driver.findElement(locator(Rprop.getProperty("cust_doc_adv_amount"))).getText();
						String cust_doc_adv_fee= driver.findElement(locator(Rprop.getProperty("cust_doc_adv_fee"))).getText();
						String cust_doc_nsf_amount= driver.findElement(locator(Rprop.getProperty("cust_doc_nsf_amount"))).getText();
						String cust_doc_wo_amount= driver.findElement(locator(Rprop.getProperty("cust_doc_wo_amount"))).getText();
						String cust_doc_interest_fee= driver.findElement(locator(Rprop.getProperty("cust_doc_interest_fee"))).getText();
						String cust_doc_origination_fee= driver.findElement(locator(Rprop.getProperty("cust_doc_origination_fee"))).getText();
						String cust_doc_credit_or_verif_fee= driver.findElement(locator(Rprop.getProperty("cust_doc_credit_or_verif_fee"))).getText();
						String cust_doc_epp_fee= driver.findElement(locator(Rprop.getProperty("cust_doc_epp_fee"))).getText();*/
