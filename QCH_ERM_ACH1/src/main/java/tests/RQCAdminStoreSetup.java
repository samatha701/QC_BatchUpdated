...
public class RQCAdminStoreSetup extends QCStore
{
	...
	try{
		...
		//driver.findElement(locator(Rprop.getProperty("admin_store_setup_tab"))).click(); 
		Thread.sleep(8000);
	...
	//driver.findElement(locator(Rprop.getProperty("admin_store_config"))).click();
	Thread.sleep(5000);
	...
	driver.switchTo().frame("mainFrame");
    Thread.sleep(5000);
	//driver.findElement(locator(Rprop.getProperty("admin_store_edit"))).click();
	...
	//driver.findElement(locator(Rprop.getProperty("admin_store_nbr"))).sendKeys(StoreID);
	//Thread.sleep(6000);
	...
	//driver.findElement(locator(Rprop.getProperty("admin_store_submit_btn"))).click();
	Thread.sleep(500);
	...
	//driver.findElement(locator(Rprop.getProperty("admin_store_status"))).sendKeys("Open");
	...
	//driver.findElement(locator(Rprop.getProperty("admin_store_edit_submit"))).click();
	Thread.sleep(1000);
	...
	Thread.sleep(5000);
	//driver.findElement(locator(Rprop.getProperty("admin_store_ok_btn"))).click();
