...
*/			int lastrow=TestData.getLastRow("Payment");
			...
			{		
				...
				if(SSN.equals(RegSSN))
				{
					...
					Thread.sleep(5000);
					if(driver.findElement(By.xpath("//input[@class='sortbuttons' and @value='No']")).isDisplayed())
					{
					Thread.sleep(5000);
...
/*break;
	...
	public static void partialPayment (String SSN,String AppURL) throws Exception
	{
		try{
			int lastrow=TestData.getLastRow("Payment");
			String sheetName="Payment";
