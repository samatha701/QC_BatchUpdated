...
public class STestBase {
	public static String FileName;
	 ...
	 //      reports.addSystemInfo("Browser Version","Chrome 69");
	        ...
	        //prop=Sprop.getProperty("user.dir")+"/Tests/Objects.properties";
	      	...
	      	//Sprop.load(input);
	      	//System.out.println(Sprop.getProperty("LendNation_URL"));
	      	
	      
	      		Sreader = new BufferedReader(new FileReader("C:/QC_LOC/src/test/java/tests/SObjects.properties"));
