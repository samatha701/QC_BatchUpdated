...
public class ILPRefinanceprocess extends CSR{
	...
	public static void Refinance(String SSN,String AppURL) throws InterruptedException
	{
			...
			{		
				...
				{
					String ESign_CourtesyCallConsent = "Yes";
					String ESign_Preference = "Call";
					
				
					String TenderType = "Cash";
					String ESign_CollateralType = "Check";
					...
					//if(stepupmsg.contains("Step Same")){
						...
						driver.findElement(By.name("requestBean.siilBean.courtesyCallFlag")).sendKeys("Yes");
						test.log(LogStatus.PASS, "Courtesy Call Consent is selected as Yes");
