...
public class LOC_CSRNewLoan extends CSR{
...
public static void LOC() throws InterruptedException
{
	...
	String Statementdate=driver.findElement(By.xpath("//*[@id='riskViewBdy']/table[3]/tbody/tr[1]/td/table/tbody/tr[3]/td/table/tbody/tr[4]/td[5]/table/tbody/tr[4]/td[2]")).getText();
	...
	test.log(LogStatus.PASS, "Clicked on loan button");
		...
		String Duedate_confirm_text3=Due_Date1+"/"+Due_Date2+"/"+Due_Date3;
