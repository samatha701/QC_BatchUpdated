...
public class PDL_EditBorrowRegestration_Save_Exit {
...
public class CSRBorrowRegestration_Save_Exit {
...
public class PDL_EditBorrowRegestration_Save_Exit extends CSR{
		...
		{	
			...
			{		
				...
				Thread.sleep(5000);
					...
					Thread.sleep(5000);
					/*wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//input[@value='Go' and @type='button']")));
					driver.switchTo().defaultContent();
					driver.switchTo().frame("mainFrame");
					driver.switchTo().frame("main");
					Thread.sleep(5000);
