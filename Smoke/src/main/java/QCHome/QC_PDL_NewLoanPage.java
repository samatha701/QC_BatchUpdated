...
public class QC_PDL_NewLoanPage extends CSR{
	...
	public static void newLoan(String SSN,String AppURL) throws Exception
	{
		...
		{	
			...
			{		
				...
				No_of_checks=TestData.getCellData(sheetName,"ESign_Checks",row);
	...
	public static void PDL() throws InterruptedException
	{
		...
		test.log(LogStatus.PASS, "Yes button ");
		
		if(ESign_CollateralType.equalsIgnoreCase("ACH")||ESign_CollateralType.equalsIgnoreCase("CHECK")){													
			                                            
		String confirm_text1=driver.findElement(By.xpath("/html/body/form/table/tbody/tr/td/table/tbody/tr/td/table[1]/tbody/tr[4]/td[2]/table/tbody/tr[1]/td")).getText();
		String confirm_text2=driver.findElement(By.xpath("/html/body/form/table/tbody/tr/td/table/tbody/tr/td/table[1]/tbody/tr[4]/td[2]/table/tbody/tr[2]/td")).getText();
		String confirm_text3=driver.findElement(By.xpath("/html/body/form/table/tbody/tr/td/table/tbody/tr/td/table[1]/tbody/tr[4]/td[2]/table/tbody/tr[3]/td")).getText();
		String confirm_text4=driver.findElement(By.xpath("/html/body/form/table/tbody/tr/td/table/tbody/tr/td/table[1]/tbody/tr[4]/td[2]/table/tbody/tr[5]/td")).getText();
		test.log(LogStatus.PASS, "confirm text is  "+confirm_text1+" Will receive an "+confirm_text2+" of "+confirm_text3+" First payment date is "+confirm_text4);
			...
			String confirm_text1=driver.findElement(By.xpath("/html/body/form/table/tbody/tr/td/table/tbody/tr/td/table[1]/tbody/tr[4]/td[2]/table/tbody/tr[1]/td/b[1]")).getText();
			String confirm_text2=driver.findElement(By.xpath("/html/body/form/table/tbody/tr/td/table/tbody/tr/td/table[1]/tbody/tr[4]/td[2]/table/tbody/tr[1]/td/b[2]")).getText();
			//String confirm_text3=driver.findElement(By.xpath("/html/body/form/table/tbody/tr/td/table/tbody/tr/td/table[1]/tbody/tr[4]/td[2]/table/tbody/tr[1]/td/b[3]]")).getText();
			String confirm_text4=driver.findElement(By.xpath("/html/body/form/table/tbody/tr/td/table/tbody/tr/td/table[1]/tbody/tr[4]/td[2]/table/tbody/tr[1]/td/b[4]")).getText();
			test.log(LogStatus.PASS, "confirm text is  "+confirm_text1+" Will receive a Cash advance of "+confirm_text2+" today. We are holding Debit Card as collateral in the Amt  (Principal + Fees) will be held until Monday, "+confirm_text4);
		}
		...
		{
			test.log(LogStatus.INFO, "<FONT color=Red style=Arial>New Loan Is Failed ");
		}
