...
public class History extends CSR{
		...
		{	
			...
			{	
				...
				{	
					...
					if(driver.findElement(By.xpath("/html/body/table/tbody/tr/td/table/tbody/tr/td/form/table[3]/tbody/tr[3]/td[6]")).getText().contains("Buyback")){
						test.log(LogStatus.PASS, "History page is working ");
						
					}
					else{
						test.log(LogStatus.FAIL, "History page is not working ");
					}
