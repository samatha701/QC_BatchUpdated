...
public class QC_BorrowRegestration_EditSSN extends CSR{
	...
	public static void borrower_saveexit_editssn(String SSN,String AppURL) throws Exception
	{

		test.log(LogStatus.INFO, "*****Performing  Edit SSN *****");
		...
		{	
			...
			String EDITSSN=TestData.getCellData(sheetName,"EDITSSN",row);	
			...
			{		
				...
				Thread.sleep(3000);
					...
					Thread.sleep(1000);
					String CustomerNbr=driver.findElement(By.xpath("/html/body/table/tbody/tr[1]/td[1]/table[2]/tbody/tr[2]/td/table/tbody/tr[2]/td[2]/a")).getText();
					test.log(LogStatus.INFO, "Customer Nbr is :"+CustomerNbr);
					Thread.sleep(3000);
					...
					//System.out.println(CustomerNbr);
					Thread.sleep(1000);
					driver.switchTo().defaultContent();
					driver.switchTo().frame("mainFrame");
					driver.findElement(By.xpath("//*[@id='988190542']/a")).click();
					test.log(LogStatus.INFO, "Clicked on Edit SSN Tab");
					Thread.sleep(1000);
					driver.switchTo().frame("main");
					driver.findElement(By.name("requestBean.cusNbr")).sendKeys(CustomerNbr);
					test.log(LogStatus.INFO, "Customer Nbr Entered as :"+CustomerNbr);
					Thread.sleep(500);
					...
					Thread.sleep(5000);
					driver.findElement(By.name("newSSN")).sendKeys(EDITSSN);
					test.log(LogStatus.PASS, "New SSN Entered as:"+EDITSSN);
					Thread.sleep(500);
					driver.findElement(By.name("confirmSSN")).sendKeys(EDITSSN);
					test.log(LogStatus.PASS, "Confirm SSN Entered as:"+EDITSSN);
					Thread.sleep(500);
					driver.findElement(By.name("comments")).sendKeys(Comments);
					test.log(LogStatus.PASS, "Comments Entered as:"+Comments);
					Thread.sleep(500);
					...
					test.log(LogStatus.PASS, "Clicked on Successful OK");
					
					test.log(LogStatus.PASS, "<FONT color=green> Customer Data is Updated Successfully with New SSN as " +EDITSSN);	
