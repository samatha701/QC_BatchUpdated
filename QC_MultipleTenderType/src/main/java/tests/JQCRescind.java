...
public class JQCRescind extends QCStore {
	...
	{
		try{
			int lastrow=TestData.getLastRow((Jprop.getProperty("RescindLoan")));
			String sheetName=Jprop.getProperty("RescindLoan");
			...
			for(String winHandle : driver.getWindowHandles()){
				  ...
				  if(ProductID.equals(Jprop.getProperty("PDL")))
					 {
				    driver.findElement(By.xpath(" /html/body/form[1]/table/tbody/tr/td/table/tbody/tr/td/table[2]/tbody/tr[7]/td[2]/table/tbody/tr/td/table/tbody/tr[4]/td[11]/input[1]")).click();
				    test.log(LogStatus.PASS, "Clicked on Go button under Loans section");
				    }
				    if(ProductID.equals(Jprop.getProperty("TLP")))
					 {
				    	driver.findElement(By.xpath("/html/body/form[1]/table/tbody/tr/td/table/tbody/tr/td/table[2]/tbody/tr[7]/td[2]/table/tbody/tr/td/table/tbody/tr[4]/td[13]/input")).click();
					 }
				    
				   
				    if(ProductID.equals(Jprop.getProperty("LOC")))
					 {
					   ...
					   driver.switchTo().defaultContent();
						...
						Thread.sleep(2000);
							...
							for( String winHandle1 : driver.getWindowHandles())
							{
							 ...
							 driver.switchTo().frame("mainFrame");
							 driver.switchTo().frame("main");
							 driver.findElement(locator(Jprop.getProperty("transactionList"))).sendKeys("Rescind");
							 ...
							 String ele= driver.findElement(locator(Jprop.getProperty("Rescind_loanAmt"))).getText();
							 driver.findElement(locator(Jprop.getProperty("Refinance_tenderType"))).sendKeys(TenderType);
							 test.log(LogStatus.PASS, "Select the Tender type is "+TenderType);
							 driver.findElement(locator(Jprop.getProperty("Refinance_tenderAmt"))).sendKeys(ele);
							 test.log(LogStatus.PASS, "Enter the Tender amount is "+ele);
							 ...
							 test.log(LogStatus.PASS, "Click on Rescind finish button");
							 try { 
