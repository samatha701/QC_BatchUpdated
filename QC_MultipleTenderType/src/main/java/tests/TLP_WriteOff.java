...
public class TLP_WriteOff extends QCStore {
	public static void writeoff(String SSN, String AppURL) throws Exception {
		...
		for (i = 0; i < 3; i++) {
			...
			try {
				// String FileName=
				// Aprop.getProperty("QC_Store_NewLoan_file_name");

				// ExcelNew TestData = new
				// ExcelNew(System.getProperty("user.dir")+Aprop.getProperty("QC_Store_NewLoan_Test_data_sheet_path")+FileName+".xls");
