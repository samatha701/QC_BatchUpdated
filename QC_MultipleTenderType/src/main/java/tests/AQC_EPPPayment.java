...
public class AQC_EPPPayment extends QCStore {
	...
	public static void epppayment(String SSN, String AppURL) throws InterruptedException {
					...
					String paymentamount= driver.findElement(By.name("transactionDataBean.paymentAmt")).getAttribute("value");
					 ...
					 TenderAmount1=paymentamount;
						...
						if((TenderType1.equalsIgnoreCase("CashierCheck")||TenderType1.equalsIgnoreCase("MoneyOrder"))&&TenderType2.equalsIgnoreCase("Cash")){
						 ...
						 Thread.sleep(2000);
						 try{
							 driver.findElement(By.name("transactionDataBean.chkNbr")).sendKeys(ChkgAcctNbr); 
							 test.log(LogStatus.PASS, "Check number enterd as "+ChkgAcctNbr);
						 }
						 catch(Exception e)
						 {
							 test.log(LogStatus.PASS, "Check number is not required");
						 }
						 driver.findElement(By.name("transactionDataBean.chkgAcctNbr")).sendKeys(last4cheknum);
						 test.log(LogStatus.PASS, "Checking account number enterd as "+last4cheknum);
					 ...
					 test.log(LogStatus.PASS," NSF payment Completed Successfully");
