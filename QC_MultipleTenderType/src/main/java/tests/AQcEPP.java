					...
					{		
					   ...
					   driver.switchTo().frame("topFrame");
					    ...
					    Thread.sleep(2000);					  
						 ...
						 try{
						 driver.findElement(By.name("chkNbr")).sendKeys(ChkgAcctNbr);
						 test.log(LogStatus.PASS, "Chec number  is :"+ChkgAcctNbr);
						 }
						 catch(Exception e)
						 {
							 test.log(LogStatus.PASS, "Checking account number  is not required for this ");
						 }
						 ...
						 if(driver.findElement(By.name("checkyes")).isDisplayed())
							{
								test.log(LogStatus.PASS, "EPP Transaction Completed ");
								test.log(LogStatus.INFO, "**********************************************************************************");
								
							}
							else
							{
								test.log(LogStatus.FAIL, "EPP Transaction Failed ");
							}
