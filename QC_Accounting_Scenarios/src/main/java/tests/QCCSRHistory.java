	...
	public static void history(String SSN,String AppURL) throws ParseException, InterruptedException
	{
	 ...
	 //ACH collateral details from sheet
			 ...
			 //Validations
						...
						String loan_account_inf_loan_nbr= driver.findElement(locator(Sprop.getProperty("loan_account_inf_loan_nbr"))).getText();
						String loan_account_inf_loan_amt= driver.findElement(locator(Sprop.getProperty("loan_account_inf_loan_amt"))).getText();
						//String loan_account_inf_finance_charge= driver.findElement(locator(Sprop.getProperty("loan_account_inf_finance_charge"))).getText();
						String loan_account_inf_APR= driver.findElement(locator(Sprop.getProperty("loan_account_inf_APR"))).getText();
						...
						String loan_account_inf_inst_amt= driver.findElement(locator(Sprop.getProperty("loan_account_inf_loan_date"))).getText();
						String loan_account_inf_no_of_installments= driver.findElement(locator(Sprop.getProperty("loan_account_inf_max_term_date"))).getText();
						...
						String loan_account_inf_original_store= driver.findElement(locator(Sprop.getProperty("loan_account_inf_original_store"))).getText();
						...
						String cust_promotion_coupon_code= driver.findElement(locator(Sprop.getProperty("cust_promotion_coupon_code"))).getText();
...
//Loan paid to date summary
						...
						//String cust_transaction_date= driver.findElement(locator(Sprop.getProperty("cust_transaction_date"))).getText();
