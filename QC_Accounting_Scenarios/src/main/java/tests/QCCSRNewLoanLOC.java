...
public class QCCSRNewLoanLOC extends QCStore{
	...
	public static String Min_LOC_Amt;
	public static String Max_LOC_Amt;
	...
	public static void newLoan(String SSN,String AppURL) throws Exception
	{
		...
		{	
			...
			{		
				...
				Min_LOC_Amt=TestData.getCellData(sheetName,"Min_LOC_Amt",row);
				Max_LOC_Amt=TestData.getCellData(sheetName,"Max_LOC_Amt",row);
...
public static void LOC() throws InterruptedException
{
	...
	test.log(LogStatus.PASS, "Clicked on loan button");
		...
		e1.click();
		e1.sendKeys(Keys.chord(Keys.BACK_SPACE, Keys.BACK_SPACE,Keys.BACK_SPACE,Keys.BACK_SPACE,Keys.BACK_SPACE,Keys.BACK_SPACE,Keys.BACK_SPACE,Keys.BACK_SPACE)+LOCamount2);
		test.log(LogStatus.PASS, "(LOC)Loan amount entered as  "+LOCamount2);
		
		if(Min_LOC_Amt.equalsIgnoreCase("Yes"))
		{
		e1.sendKeys(Keys.chord(Keys.BACK_SPACE, Keys.BACK_SPACE,Keys.BACK_SPACE,Keys.BACK_SPACE,Keys.BACK_SPACE,Keys.BACK_SPACE,Keys.BACK_SPACE,Keys.BACK_SPACE)+MinLOCamount);
		test.log(LogStatus.PASS, "(LOC)Loan amount entered as  "+MinLOCamount);
		}
		if(Max_LOC_Amt.equalsIgnoreCase("Yes"))
		{
		e1.sendKeys(Keys.chord(Keys.BACK_SPACE, Keys.BACK_SPACE,Keys.BACK_SPACE,Keys.BACK_SPACE,Keys.BACK_SPACE,Keys.BACK_SPACE,Keys.BACK_SPACE,Keys.BACK_SPACE)+MaxLOCamount);
		test.log(LogStatus.PASS, "(LOC)Loan amount entered as  "+MaxLOCamount);
		}
		Thread.sleep(5000);
		driver.findElement(By.name("intRate")).click();
		Thread.sleep(5000);
		...
		if (ESign_CollateralType.equals("ACH"))
		{
			...
			else if(Max_LOC_Amt.equalsIgnoreCase("Yes"))
			{
			
			driver.findElement(By.name("advanceRequestBean.disbAmtFirst")).sendKeys(MaxLOCamount);
			
			test.log(LogStatus.PASS, "Disb amount enterd  as "+MaxLOCamount);
			}
