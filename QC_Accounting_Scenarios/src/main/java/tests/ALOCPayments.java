...
public class ALOCPayments extends QCStore{
	...
	{	
		...
		{	
			...
			{	
				...
				/*PaymentAmount=driver.findElement(By.xpath("/html/body/form/table/tbody/tr[2]/td/table/tbody/tr[3]/td/table/tbody/tr[3]/td[1]/table/tbody/tr[1]/td[2]")).getText();
				double PaymntFLT=Double.valueOf(PaymentAmount);
				PaymntFLT=PaymntFLT-10.00;
				PaymentAmount = Double.toString(PaymntFLT);
