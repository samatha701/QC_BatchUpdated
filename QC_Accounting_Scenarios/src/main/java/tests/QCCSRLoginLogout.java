...
public class QCCSRLoginLogout extends QCStore
{
	...
	public static void login(String SSN,String csr_url) throws MalformedURLException, InterruptedException
	{
		...
		//	ExcelNew TestData = new ExcelNew(System.getProperty("user.dir")+prop.getProperty("QC_Store_NewLoan_Test_data_sheet_path")+FileName+".xls");  		 
				...
				{		
					...
					//String username = "csr1706";
					String username = TestData.getCellData(sheetName,"UserName",row);
					String password = TestData.getCellData(sheetName,"Password",row);
					//String store_id = "1706";
					...
					{	
						...
						//test.log(LogStatus.INFO, MarkupHelper.createLabel("Opened the CSR URL " +csr_url, ExtentColor.BLUE));
					    ...
					    driver.findElement(locator(Sprop.getProperty("csr_password"))).clear();
					    driver.findElement(locator(Sprop.getProperty("csr_password"))).sendKeys(password);
				        test.log(LogStatus.PASS, "Password is entered: "+password);
				        
				       
				        driver.findElement(locator(Sprop.getProperty("csr_storeid"))).sendKeys(store_id);;
				        test.log(LogStatus.PASS, "Storenumber is entered: "+store_id);
				        //Click Login Button
				        driver.findElement(locator(Sprop.getProperty("csr_login_button"))).click();
...
public static void logout(String SSN,String csr_url){
			...
			driver.findElement(locator(Sprop.getProperty(("csr_logout_link")))).click();
...
*/
	...
	public static void adminLogin(String SSN,String csr_url){
	...
	driver.findElement(locator(Sprop.getProperty(("admin_logout_link")))).click();
	     test.log(LogStatus.PASS, "Clicked On logout Button");
	     if(driver.getTitle().contains("Login")){
	    	 test.log(LogStatus.PASS, "Logout is Successfully"); 
