		...
		{		
			...
			{		
				...
				if(Esign_CollateralType.equalsIgnoreCase("ACH")){
						...
						Thread.sleep(500);
						driver.findElement(By.name("transactionDataBean.checkAcctNbr")).sendKeys(last4cheknum);
						test.log(LogStatus.PASS, "Collateral Type is enterted as "+last4cheknum);
					}
					...
					WebElement e1=driver.findElement(By.name("transactionDataBean.paymentAmt"));
					String PayAmount= e1.getAttribute("value");
					Thread.sleep(500);
					...
					.sendKeys(Keys.chord(Keys.BACK_SPACE, Keys.BACK_SPACE, Keys.BACK_SPACE, Keys.BACK_SPACE,Keys.BACK_SPACE, Keys.BACK_SPACE, Keys.BACK_SPACE, Keys.BACK_SPACE)
							+ LoanAmount);*/
					test.log(LogStatus.PASS, "Entered Loan amount as  :"+PayAmount);
					
					driver.findElement(By.name("transactionDataBean.tenderTypeFirst")).sendKeys(TenderType);
	                
					test.log(LogStatus.PASS, "Select tender type as "+TenderType);
					try{
						driver.findElement(By.name("transactionDataBean.ccmoNbrFirst")).sendKeys(last4cheknum);
						test.log(LogStatus.PASS, "check no enetered as "+last4cheknum);
					}
					catch(Exception e){
						
					}
					driver.findElement(By.name("transactionDataBean.tenderAmtFirst")).sendKeys(PayAmount);
					Thread.sleep(500);
					...
					driver.findElement(By.xpath("//input[@value='Finish Refinance']")).click();
