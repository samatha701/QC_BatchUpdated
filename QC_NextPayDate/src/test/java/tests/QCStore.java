...
public class QCStore {
	...
	// Brahmith Transactions
      @Test(priority = 0, groups = "NextPayDate")
	  public static void Payfrequency_Biweekly() throws Exception {
		

			test = reports.startTest("Bi-Weekly_frequency","Frequency verification");

			FileName = "Frequency.xls";
	...
	@Test(priority = 1, groups = "NextPayDate")
	public static void Payfrequency_Weekly() throws Exception {
		

			test = reports.startTest("Weekly_frequency","Weekly Frequency verification");

			FileName = "Frequency_weekly.xls";
       ...
       @Test(priority = 2, groups = "NextPayDate")
       public static void Payfrequency_Monthly() throws Exception {
		

			test = reports.startTest("Monthly_frequency","Monthly Frequency verification");

			FileName = "Frequency_Monthly.xls";
	...
	@Test(priority = 3, groups = "NextPayDate")
	public static void Payfrequency_Semi_monthly() throws Exception {
		

			test = reports.startTest("Frequency_Semi_monthly_scenario","Semi_monthly Frequency verification");

			FileName = "Frequency_Semi_monthly.xls";
		...
		try {
			...
			try {
				reader = new BufferedReader(
						...
						new FileReader("C:/QC_Batch_Recon/QC_NextPayDate/src/test/java/tests/Objects.properties"));
