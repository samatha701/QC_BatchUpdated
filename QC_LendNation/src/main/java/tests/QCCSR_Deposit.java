...
public class QCCSR_Deposit extends LendNation{
						   ...
						   driver.switchTo().defaultContent();
							...
							if(Esign_CollateralType.equalsIgnoreCase("ACH"))
							{
								for( String winHandle1 : driver.getWindowHandles())
								{
								 ...
								 Thread.sleep(1000);
								 driver.findElement(By.xpath("/html/body/table/tbody/tr/td/table/tbody/tr/td/form/table[4]/tbody/tr[6]/td[1]/input")).click();
								 ...
								 Thread.sleep(500);
								 driver.findElement(By.xpath("/html/body/form/table/tbody/tr[6]/td/input")).sendKeys(PIN);
								 test.log(LogStatus.PASS, "Pin Entered as : "+PIN);
								 Thread.sleep(500);
								 driver.findElement(By.xpath("//*[@id='finish']")).click();
								 test.log(LogStatus.PASS, "Clicked on Finish ACH Deposit button ");
								 Thread.sleep(5000);
								 ...
								 if(driver.findElement(By.xpath("//*[@class='sortbuttons']")).isDisplayed())
								 {
									 ...
									 driver.findElement(By.xpath("//input[@value='No' and @type='button']")).click();
