...
public class QCCSRReturnPosting extends LendNation {
				...
				if (SSN.equals(RegSSN)) {
					...
					if (Esign_CollateralType.equalsIgnoreCase("ACH")) {
						...
						driver.findElement(By
								.xpath("/html/body/table/tbody/tr/td/table/tbody/tr/td[1]/form/table[2]/tbody/tr[2]/td[2]/table/tbody/tr[2]/td[1]/font/b/input")).click();
						...
						driver.switchTo().frame("main");
				//Due_Date="08/05/2019";
						String App_date[] = Due_Date.split("/");
