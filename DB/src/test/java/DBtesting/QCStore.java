...
public class QCStore {
	...
	public static String SSN_DB;
	public static String first_name_db;
	public static String last_name_db;
	public static String drivers_lin_db;
	...
	public static void DBtesting() throws Exception {
		try {

			test = reports.startTest("DBtesting_scenario","DBtesting");

			FileName = prop.getProperty("DBtesting_file_name") + ".xls";
			...
			for (int row = 2; row <= lastrow; row++) {
				...
				if (RunFlag.equals("Y")) {
					...
					DBconnection.connection(SSN,AppURL);
					QCValidations.validation(SSN, SSN);
		...
		try {
			...
			try {
				reader = new BufferedReader(
						...
						new FileReader("C:/QC_Batch/DB/src/test/java/DBtesting/Objects.properties"));
