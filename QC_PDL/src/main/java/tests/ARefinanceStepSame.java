...
public class ARefinanceStepSame extends QCStore {
	...
	public static void StepSame(String SSN,String AppURL) throws Exception{
		...
		{		
			...
			{		
				...
				Thread.sleep(3000);
				test.log(LogStatus.INFO,"**************Refinance Step Same   started**************");
				...
				for(String winHandle : driver.getWindowHandles())
				{
					if(!mainWindow.equalsIgnoreCase(winHandle))
					{
						...
						e.clear();
						e.sendKeys(pbalstr);
						driver.findElement(By.xpath(" /html/body/form[1]/table[2]/tbody/tr[2]/td/table/tbody/tr[1]/td/table/tbody/tr[10]/td/input")).click();
						Thread.sleep(3000);
						...
						test.log(LogStatus.PASS, "Stepsame amount is "+stpamt);
						...
						driver.findElement(locator(Aprop.getProperty("refinance_yes_button"))).click();
