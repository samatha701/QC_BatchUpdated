	...
	try{
			...
			{		
				...
				if(SSN.equals(RegSSN))
				{
					...
					// String last4cheknum = TestData.getCellData(sheetName,"ChkgAcctNbr_lastfour",row);
						...
						String  ESign_CheckNbr=SSN.substring(SSN.length() - 6);
						String  last4cheknum=SSN.substring(SSN.length() - 4);
								 ...
								 for(String winHandle : driver.getWindowHandles())
									{
									 if(!mainWindow.equalsIgnoreCase(winHandle))
									 {
										 ...
										 driver.switchTo().defaultContent();
										    driver.switchTo().frame("mainFrame");
										    driver.switchTo().frame("main");
										 //test.log(LogStatus.PASS, "Switching to the window "+driver.getTitle());
										...
										// Thread.sleep(5000);
										 driver.findElement(By.name("transactionDataBean.paymentAmt")).sendKeys(Keys.chord(Keys.BACK_SPACE, Keys.BACK_SPACE,Keys.BACK_SPACE,Keys.BACK_SPACE,Keys.BACK_SPACE,Keys.BACK_SPACE)+pbalstr);
										 test.log(LogStatus.PASS, "entered the amount as "+ pbalstr);
										 Thread.sleep(3000);
										 driver.findElement(locator(prop.getProperty("refinance_password"))).click();
										 Thread.sleep(3000);
										// driver.findElement(By.name("qualify")).click();
										 driver.findElement(By.xpath("//input[@name='qualify' and @value='Qualify']")).click();
										 //Thread.sleep(8000);
										...
										// driver.findElement(By.name("qualify")).click();
										 ...
										 if(Collateral.equalsIgnoreCase("ACH"))
										 {
											...
											driver.findElement(By.xpath(" /html/body/form[1]/table[2]/tbody/tr[2]/td/table/tbody/tr[1]/td/table/tbody/tr[3]/td/table/tbody/tr/td/select")).sendKeys(No_of_checks);
											 ...
											 {
											 driver.findElement(locator(prop.getProperty("refinance_courtesy_call"))).sendKeys(ESign_CourtesyCallConsent);
											 test.log(LogStatus.PASS, "Courtesy Call Consent selected as "+ESign_CourtesyCallConsent);
											 Thread.sleep(2000);
											 driver.findElement(By.xpath(" //*[@id='preferenceCall']")).click();
											 test.log(LogStatus.PASS, "Esign preference selected as "+ESign_Preference);
											 ...
											 driver.findElement(locator(prop.getProperty("refinance_select_card_type"))).sendKeys(cardType);
							            	 ...
							            	 driver.findElement(locator(prop.getProperty("refinance_card_holder_name"))).sendKeys(CardHolderName);
							            	 ...
							            	 test.log(LogStatus.PASS, "Clicked on add card button ");
												...
												//*[@id="tenderAmtStyle"]/td[2]/input
												 String paymentAmount=driver.findElement(locator(prop.getProperty("refinance_payment_amount"))).getAttribute("value");
											 ...
											 String rebate= driver.findElement(locator(prop.getProperty("refinance_rebate_amount"))).getAttribute("value");
												...
												//String stepdownamount= driver.findElement(locator(prop.getProperty("refinance_step_down_amount"))).getAttribute("value");
												test.log(LogStatus.PASS, "Step Down amount is "+pbalstr);
												Thread.sleep(2000);
...
break;
		...
		if(i==3)
		{
			test.log(LogStatus.FAIL, "Refinance Step down is failed");
								 ...
								 for(String winHandle : driver.getWindowHandles())
									{
									 if(!mainWindow.equalsIgnoreCase(winHandle))
									 {
										...
										// Thread.sleep(5000);
										 ...
										 driver.findElement(By.name("transactionDataBean.advAmt")).sendKeys(pbalstr);
										 test.log(LogStatus.PASS, "Entered the amount same as principal balance : "+pbalstr);
										...
										// driver.findElement(By.name("qualify")).click();
										 ...
										 if(Collateral.equalsIgnoreCase("ACH"))
										 {
											try{ driver.findElement(By.xpath("//*[@id='chkgAcctNbr']")).sendKeys(last4cheknum);
												test.log(LogStatus.PASS, "Chkg Acct Number enterd"+last4cheknum);
											}
											catch(Exception e)
											{
										...
										// else
										 {
											// test.log(LogStatus.FAIL, "Steup amount condition Not satisfied ");
										 }
...
break;
					...
					//test.log(LogStatus.FAIL, MarkupHelper.createLabel("Getting Encryption from Admin is failed", ExtentColor.RED));
					test.log(LogStatus.INFO, " "+e);
					String screenshotPath = getScreenhot(driver, "Refinance");
		...
		if(i==3)
		{
			test.log(LogStatus.FAIL, "Refinance Step Same is failed");
			Assert.assertTrue(false);
