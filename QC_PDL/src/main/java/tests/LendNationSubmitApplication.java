...
public class LendNationSubmitApplication extends LendNation{
	  ...
	  public static void submitApplication(String SSN,String AppURL) throws Exception
	  {
		  try{
			...
			// test.log(Status.INFO, "Lend Nation application navigated to Submit Application page " );
			test.log(Status.INFO, MarkupHelper.createLabel("Lend Nation application navigated to Submit Application page",ExtentColor.BLUE ));


			  test.log(Status.PASS, "Entered Loan Amount as : " + LoanAmount);
			...
			//driver.findElement(locator(prop.getProperty("check_box_signature"))).click();
			  ...
			  test.log(Status.PASS, "Entered the Verification code " );
			  Thread.sleep(10000);
			  driver.findElement(locator(prop.getProperty("confirm_button"))).click();
			  test.log(Status.PASS, "Clicked on Confirm " );
			  ...
			  test.log(Status.PASS, "Checked the radio button of Rate Chart, License and Related State Disclosures " );
/*
			...
			*/
			...
			test.log(Status.PASS, "Accepted the Rate Chart, License and Related State Disclosures " );
			 Thread.sleep(5000);
			driver.findElement(locator(prop.getProperty("radio_button_email"))).click();
			  test.log(Status.PASS, "Selected Radio button for email documents " );
			Thread.sleep(5000);
			...
			wait.until(ExpectedConditions.elementToBeClickable(driver.findElement(locator(prop.getProperty("checkbox1_signpage")))));
			 ...
			 if( driver.findElement(locator(prop.getProperty("checkbox1_signpage"))).isEnabled())
			  {
					//test.log(Status.PASS, "Submitted Application Successfully with SSN : " +SSN);	
					test.log(Status.PASS, MarkupHelper.createLabel("Submitted Application Successfully with SSN : " +SSN,ExtentColor.GREEN ));

				 	}
					else
					{
					test.log(Status.FAIL, " Application not submitted successfully with SSN : " +SSN);
					}
		  ...
		  {
			  test.log(Status.ERROR, "Unable to submit App with SSN  " +SSN);
