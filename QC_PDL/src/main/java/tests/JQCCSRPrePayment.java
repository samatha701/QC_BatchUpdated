...
public class JQCCSRPrePayment extends QCStore{
	...
	try{
			...
			{		
				...
				if(SSN.equals(RegSSN))
				{
					...
					test.log(LogStatus.PASS, " click on finish Prepayment button");
					try {
					...
					if(driver.findElement(By.xpath("//*[@class='sortbuttons']")).isDisplayed())
					{
						...
						test.log(LogStatus.PASS, " Prepayment  is successfull");
	...
	//}
		...
		e.printStackTrace();
		test.log(LogStatus.FAIL,"PrePayment is failed");
