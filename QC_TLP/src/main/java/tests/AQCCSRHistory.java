	...
	public static void history(String SSN,String AppURL) throws ParseException, InterruptedException
	{
	 ...
	 //ACH collateral details from sheet
			 ...
			 //Validations
					...
					/*	String loan_account_inf_product_name= driver.findElement(locator(Aprop.getProperty("loan_account_inf_product_name"))).getAttribute("value");
						...
						String loan_account_inf_inst_amt= driver.findElement(locator(Aprop.getProperty("loan_account_inf_inst_amt"))).getText();
						String loan_account_inf_no_of_installments= driver.findElement(locator(Aprop.getProperty("loan_account_inf_no_of_installments"))).getText();
...
//Loan paid to date summary
						...
						//String cust_doc_new_balance= driver.findElement(locator(Aprop.getProperty("cust_doc_new_balance"))).getText();
