		...
		try{
			...
			{		
				...
				{		       
					...
					driver.findElement(locator(Jprop.getProperty("Internal_Transfet_Action"))).sendKeys(Action);
					driver.findElement(locator(Jprop.getProperty("Count_Coins"))).sendKeys(CountofDollarCoins);
					String check_Nbr=driver.findElement(locator(Jprop.getProperty("Internal_check_Nbr"))).getText();
					...
					{
						driver.findElement(locator(Jprop.getProperty("Internal_select"))).click();
