	...
	public static void history(String SSN,String AppURL) throws ParseException, InterruptedException
	{
	 ...
	 //ACH collateral details from sheet
			 ...
			 //Validations
						...
						String loan_account_inf_product_name="Title Loan";
					/*	String loan_account_inf_product_name= driver.findElement(locator(Jprop.getProperty("loan_account_inf_product_name"))).getAttribute("value");
						String loan_account_inf_product_names[]=loan_account_inf_product_name.split(":");
						loan_account_inf_product_name=loan_account_inf_product_names[1].trim();*/
						String loan_account_inf_product_type= driver.findElement(locator(Jprop.getProperty("loan_account_inf_product_type"))).getText();
						String loan_account_inf_loan_nbr= driver.findElement(locator(Jprop.getProperty("loan_account_inf_loan_nbr"))).getText();
						String loan_account_inf_loan_amt= driver.findElement(locator(Jprop.getProperty("loan_account_inf_loan_amt"))).getText();
						//String loan_account_inf_finance_charge= driver.findElement(locator(Jprop.getProperty("loan_account_inf_finance_charge"))).getText();
						String loan_account_inf_APR= driver.findElement(locator(Jprop.getProperty("loan_account_inf_APR"))).getText();
						...
						String loan_account_inf_inst_amt= driver.findElement(locator(Jprop.getProperty("loan_account_inf_inst_amt"))).getText();
						String loan_account_inf_no_of_installments= driver.findElement(locator(Jprop.getProperty("loan_account_inf_no_of_installments"))).getText();
						...
						String loan_account_inf_original_store= driver.findElement(locator(Jprop.getProperty("loan_account_inf_original_store"))).getText();
						...
						String cust_promotion_campaign_names[]=cust_promotion_campaign_name.split(":");
						cust_promotion_campaign_name=cust_promotion_campaign_names[1].trim();
...
//Loan paid to date summary
						...
						//String cust_transaction_date= driver.findElement(locator(Jprop.getProperty("cust_transaction_date"))).getText();
						//*[@id="transactionDetailsTable"]/tbody/tr[3]/td[4]/font
						...
						//String cust_doc_new_balance= driver.findElement(locator(Jprop.getProperty("cust_doc_new_balance"))).getText();
						String cust_doc_PromotionCoupon_Amt= driver.findElement(By.xpath("//*[@id='transactionDetailsTable']/tbody/tr["+n+"]/td[22]/font")).getText();
						...
						else
						{
							...
							{
								test.log(LogStatus.FAIL, "finance_charge->Expected value:"+finance_charge +"; not equals to Actual value:"+loan_account_inf_no_of_installments);
							...
							if(loan_account_inf_no_of_installments_test.equalsIgnoreCase(loan_account_inf_no_of_installments))
							{
								test.log(LogStatus.PASS, "No of Instalments->Expected value:"+loan_account_inf_no_of_installments_test +"; == Actual value:"+loan_account_inf_no_of_installments);
							}
							else
							{
								test.log(LogStatus.FAIL, "No of Instalments->Expected value:"+loan_account_inf_no_of_installments_test +"; not equals to Actual value:"+loan_account_inf_no_of_installments);

							}
							
							if(collateral_type.equalsIgnoreCase(loan_account_inf_collateral_type)||"DC".equalsIgnoreCase(loan_account_inf_collateral_type))
							{
							...
							/*if(courtesy_consent_status.equalsIgnoreCase(courtesy_inf_courtesy_type))
							{
								test.log(LogStatus.PASS, "courtesy_consent_type->Expected value:"+courtesy_consent_status +"; == Actual value:"+courtesy_inf_courtesy_type);
							}
							else
							{
								test.log(LogStatus.FAIL, "courtesy_consent_type->Expected value:"+courtesy_consent_status +"; not equals to Actual value:"+courtesy_inf_courtesy_type);

							}*/
							if(courtesy_inf_courtesy_status_test.equalsIgnoreCase(courtesy_inf_courtesy_status))
							{
								test.log(LogStatus.PASS, "courtesy_consent_status->Expected value:"+courtesy_inf_courtesy_status_test +"; == Actual value:"+courtesy_inf_courtesy_status);
							}
							else
							{
								test.log(LogStatus.FAIL, "courtesy_consent_status->Expected value:"+courtesy_inf_courtesy_status_test +"; not equals to Actual value:"+courtesy_inf_courtesy_status);
							...
							{
								test.log(LogStatus.FAIL, "Interest paid to date-->Expected value:"+fee_paid_date +"; not equals to Actual value:"+loan_paid_summary_fee_paid_date);

							}
							
							if(loan_paid_summary_total_paid_amt_test.equalsIgnoreCase(loan_paid_summary_total_paid_amt))
							{
								test.log(LogStatus.PASS, "total_paid_amount->Expected value:"+loan_paid_summary_total_paid_amt_test +"; == Actual value:"+loan_paid_summary_total_paid_amt);
							}
							else
							{
								test.log(LogStatus.FAIL, "total_paid_amount->Expected value:"+loan_paid_summary_total_paid_amt_test +"; not equals to Actual value:"+loan_paid_summary_total_paid_amt);
							...
							if(cust_doc_tender_type_test.equalsIgnoreCase(cust_doc_tender_type)||" ".trim().equalsIgnoreCase(cust_doc_tender_type.trim()))
							{
							...
							if(cust_doc_PromotionCoupon_Amt_test.equalsIgnoreCase(cust_doc_PromotionCoupon_Amt)||" ".trim().equalsIgnoreCase(cust_doc_PromotionCoupon_Amt.trim()))
							{
							...
							if(ESign_CollateralType.equals("ACH"))
							{
								...
								if(ACH_status.trim().equalsIgnoreCase(ach_history_ach_status.trim()))
								{
