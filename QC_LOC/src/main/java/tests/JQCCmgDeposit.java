		...
		try{
			...
			{		
		       ...
		       Thread.sleep(4000);
				...
				String check_Nbr=driver.findElement(locator(Jprop.getProperty("cmg_checkNbr"))).getText();
				...
				{
				driver.findElement(locator(Jprop.getProperty("CmgDeposite_select"))).click();
				...
				driver.findElement(locator(Jprop.getProperty("cmgFinishDeposite"))).click();
