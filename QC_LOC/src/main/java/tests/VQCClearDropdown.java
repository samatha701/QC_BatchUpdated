...
public class VQCClearDropdown extends QCStore {
			...
			for (int row = 2; row <= lastrow; row++) {
				...
				if (SSN.equals(RegSSN)) {
					...
					if (ESign_CollateralType.equalsIgnoreCase("CHECK")) {
						...
						driver.switchTo().frame("main");
						Thread.sleep(3000);
						//wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector("li[id='930000']")));
						//driver.findElement(By.name("transactionList")).sendKeys(keysToSend);
						//driver.findElement(locator(Vprop.getProperty("transactionList"))).sendKeys(TxnType);
						driver.findElement(By.name("transactionList")).sendKeys(TxnType);
						test.log(LogStatus.PASS, "Transaction type is selected Clear Check");
						
						driver.findElement(By.name("button")).click();
						//driver.findElement(locator(Vprop.getProperty("go"))).click();
						...
						//driver.findElement(locator(Vprop.getProperty("clear_pwd"))).sendKeys(PIN);
						test.log(LogStatus.PASS, " Entered password :"+PIN );
						
						driver.findElement(By.name("finish")).click();
						
						//driver.findElement(locator(Vprop.getProperty("clear_finish"))).click();
						test.log(LogStatus.PASS, " cliked on finish Clear Check button");
						Thread.sleep(3000);
						driver.findElement(By.name("checkyes")).click();
						test.log(LogStatus.PASS, " cliked on finish checkyes button");
						driver.close();
						Thread.sleep(3000);
						if (driver.findElement(locator(Vprop.getProperty("clear_checkyes"))).isDisplayed()) {
						...
						driver.switchTo().frame("mainFrame");
						driver.switchTo().frame("main");
						driver.findElement(locator(Vprop.getProperty("transactionList"))).sendKeys("ACH Clear");
						...
						Thread.sleep(2000);
						if (driver.findElement(locator(Vprop.getProperty("success"))).isDisplayed()) {
							test.log(LogStatus.PASS, ESign_CollateralType + "Clear dropdown from CSR is successfull");
							test.log(LogStatus.PASS, "********************************************** ");
						}
					}
