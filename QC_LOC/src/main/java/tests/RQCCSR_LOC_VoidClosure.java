...
public class RQCCSR_LOC_VoidClosure extends QCStore
{

	public static void locvoidclosure(String SSN,String AppURL)
	{
		int i;
		for(i=0;i<3;i++)
		{
	...
	try{
			...
			{		
				...
				if(SSN.equals(RegSSN))
				{
					...
					Thread.sleep(3000);
					test.log(LogStatus.INFO,"Void LOC Closure started");
					...
					test.log(LogStatus.PASS, "Clicked on Void ULOC Closurwe");
...
break;
		...
		/*if(i==3)
		{
			test.log(LogStatus.FAIL, " Void LOC Closure  setup is failed");
