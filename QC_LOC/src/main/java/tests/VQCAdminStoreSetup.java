...
public class VQCAdminStoreSetup extends QCStore
{
	...
	driver.findElement(locator(Vprop.getProperty("admin_store_config"))).click();
	...
	driver.switchTo().frame("mainFrame");
Thread.sleep(2000);
	driver.findElement(locator(Vprop.getProperty("admin_store_edit"))).click();
	...
	driver.findElement(locator(Vprop.getProperty("admin_store_nbr"))).sendKeys(StoreID);

	test.log(LogStatus.PASS, "Entered Store number "+StoreID);

	driver.findElement(locator(Vprop.getProperty("admin_store_submit_btn"))).click();
	...
	driver.findElement(locator(Vprop.getProperty("admin_store_status"))).sendKeys("Open");

	test.log(LogStatus.PASS, "Store status set as Open"); 

	driver.findElement(locator(Vprop.getProperty("admin_store_edit_submit"))).click();

	test.log(LogStatus.PASS, "Clicked on Submit"); 
	Thread.sleep(2000);
	driver.findElement(locator(Vprop.getProperty("admin_store_ok_btn"))).click();
