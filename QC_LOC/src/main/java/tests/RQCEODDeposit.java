...
public class RQCEODDeposit extends QCStore{
	public static void eodDeposit(String SSN,String AppURL)
	{
		int i;
		for(i=0;i<3;i++)
		{
				...
				{		
					...
					for(String winHandle : driver.getWindowHandles()){
					   ...
					   Thread.sleep(10000);
						...
						driver.switchTo().frame("mainFrame");
						Thread.sleep(2000);
						driver.findElement(locator(Rprop.getProperty("daily_processing_start_eod"))).click();
						test.log(LogStatus.PASS, "Clicked on Start EOD processing");
						Thread.sleep(5000);
						String trans_nbr=driver.findElement(locator(Rprop.getProperty("daily_processing_trans_nbr"))).getText();	
						String trans_store=driver.findElement(locator(Rprop.getProperty("daily_processing_store_nbr"))).getText();	
						...
						RQCAdminEncryption.getEncryption(driver,SSN, AppURL); 
...
// Switchign to CSR						
						...
						driver.findElement(locator(Rprop.getProperty("daily_processing_ean_key"))).sendKeys(Eankey);
						test.log(LogStatus.PASS, "Entered the Encryption Key"+Eankey);
						driver.findElement(locator(Rprop.getProperty("daily_processing_yes_btn"))).click();
						test.log(LogStatus.PASS, "Clicked on Yes button");
						driver.findElement(locator(Rprop.getProperty("safe_balance_count_of_dollars_coins"))).sendKeys(CountofDollarCoins);
						test.log(LogStatus.PASS, "Entered in Count of Dollar coins field as "+CountofDollarCoins);
						driver.findElement(locator(Rprop.getProperty("safe_balance_EOD_comments"))).sendKeys("Test EOD");
						test.log(LogStatus.PASS, "Entered comment in Count of EOD comment field as :Test EOD");
						driver.findElement(locator(Rprop.getProperty("safe_balance_safe_bal_btn"))).click();
						test.log(LogStatus.PASS, "Clicked on Safe balance button");
						
						try{
							Thread.sleep(2000);
							driver.findElement(locator(Rprop.getProperty("over_or_short_comments"))).sendKeys("test");
						test.log(LogStatus.PASS, "Entered comment Over/short comment field as :test");
						Thread.sleep(2000);
						driver.findElement(locator(Rprop.getProperty("over_or_short_next_btn"))).click();
					test.log(LogStatus.PASS, "Clicked next under Over/short ");
						...
						Thread.sleep(3000);
						driver.findElement(locator(Rprop.getProperty("deposit_next_btn"))).click();
						...
						try{
							driver.findElement(locator(Rprop.getProperty("deposit_checkbox"))).click();
						...
						Thread.sleep(5000);
						driver.findElement(locator(Rprop.getProperty("EOD_deposit_next_btn"))).click();
						test.log(LogStatus.PASS, "Clicked next under EOD Deposit section ");
						Thread.sleep(8000);
						driver.findElement(locator(Rprop.getProperty("deposit_verify_finish_btn"))).click();
						test.log(LogStatus.PASS, "Clicked next under Deposit verify section ");
						Thread.sleep(8000);
						Thread.sleep(8000);
						driver.findElement(locator(Rprop.getProperty("EOD_ok_btn"))).click();
