...
public class VQCCSRHistory extends QCStore{
...
System.out.println(columnname+"_TxnHistory_FieldValue");
	 ...
	 //ACH collateral details from sheet
			 ...
			 //Validations
						...
						String cust_inf_customer_name= driver.findElement(locator(Vprop.getProperty("cust_inf_customer_name"))).getText();
						String cust_inf_customer_nbr = driver.findElement(locator(Vprop.getProperty("cust_inf_customer_nbr"))).getText();
						String cust_inf_customer_SSN= driver.findElement(locator(Vprop.getProperty("cust_inf_customer_SSN"))).getText();
						String cust_inf_customer_primary_phone= driver.findElement(locator(Vprop.getProperty("cust_inf_customer_primary_phone"))).getText();
						String cust_inf_customer_phone_type= driver.findElement(locator(Vprop.getProperty("cust_inf_customer_phone_type"))).getText();
						String cust_inf_customer_state= driver.findElement(locator(Vprop.getProperty("cust_inf_customer_state"))).getText();
						String cust_inf_customer_email= driver.findElement(locator(Vprop.getProperty("cust_inf_customer_email"))).getText();
						String cust_inf_customer_type= driver.findElement(locator(Vprop.getProperty("cust_inf_customer_type"))).getText();
						/*String cust_bank_inf_accout_type= driver.findElement(locator(Vprop.getProperty("cust_bank_inf_accout_type"))).getText();
						String cust_bank_inf_ABA_nbr= driver.findElement(locator(Vprop.getProperty("cust_bank_inf_ABA_nbr"))).getText();
						String cust_bank_inf_account_nbr= driver.findElement(locator(Vprop.getProperty("cust_bank_inf_account_nbr"))).getText();
						String cust_bank_inf_check_nbr= driver.findElement(locator(Vprop.getProperty("cust_bank_inf_check_nbr"))).getText();
						String cust_bank_inf_account_status= driver.findElement(locator(Vprop.getProperty("cust_bank_inf_account_status"))).getText();
						String cust_bank_inf_bank_name= driver.findElement(locator(Vprop.getProperty("cust_bank_inf_bank_name"))).getText();*/
						String employer_inf_source_of_income= driver.findElement(locator(Vprop.getProperty("employer_inf_source_of_income"))).getText();
						String employer_inf_current_employer= driver.findElement(locator(Vprop.getProperty("employer_inf_current_employer"))).getText();
						String employer_inf_netpay= driver.findElement(locator(Vprop.getProperty("employer_inf_netpay"))).getText();
						String employer_inf_grosspay= driver.findElement(locator(Vprop.getProperty("employer_inf_grosspay"))).getText();
						String employer_inf_pay_frequency= driver.findElement(locator(Vprop.getProperty("employer_inf_pay_frequency"))).getText();
						String employer_inf_employer_ph_nbr= driver.findElement(locator(Vprop.getProperty("employer_inf_employer_ph_nbr"))).getText();
						String courtesy_inf_courtesy_consent= driver.findElement(locator(Vprop.getProperty("courtesy_inf_courtesy_consent"))).getText();
						String courtesy_inf_courtesy_type= driver.findElement(locator(Vprop.getProperty("courtesy_inf_courtesy_type"))).getText();
						String courtesy_inf_courtesy_status= driver.findElement(locator(Vprop.getProperty("courtesy_inf_courtesy_status"))).getText();
						String loan_status_inf_loan_status= driver.findElement(locator(Vprop.getProperty("loan_status_inf_loan_status"))).getText();
						String loan_status_inf_checkstatus= driver.findElement(locator(Vprop.getProperty("loan_status_inf_checkstatus"))).getText();
						String loan_status_inf_due_date= driver.findElement(locator(Vprop.getProperty("loan_status_inf_due_date"))).getText();
					/*	String loan_balance_inf_principal_bal= driver.findElement(locator(Vprop.getProperty("loan_balance_inf_principal_bal"))).getText();
						String loan_balance_inf_fee_due= driver.findElement(locator(Vprop.getProperty("loan_balance_inf_fee_due"))).getText();
						String loan_balance_inf_return_fee_due= driver.findElement(locator(Vprop.getProperty("loan_balance_inf_return_fee_due"))).getText();
						String loan_balance_inf_late_fee_due= driver.findElement(locator(Vprop.getProperty("loan_balance_inf_late_fee_due"))).getText();
						String loan_balance_inf_pay_off_amt= driver.findElement(locator(Vprop.getProperty("loan_balance_inf_pay_off_amt"))).getText();*/
						String loan_account_inf_product_name= driver.findElement(locator(Vprop.getProperty("loan_account_inf_product_name"))).getText();
						String loan_account_inf_product_type= driver.findElement(locator(Vprop.getProperty("loan_account_inf_product_type"))).getText();
						
						String loan_account_inf_loan_amt= driver.findElement(locator(Vprop.getProperty("loan_account_inf_loan_amt"))).getText();
						String loan_account_inf_loc_amount= driver.findElement(locator(Vprop.getProperty("loan_account_inf_loc_amount"))).getText();
						String loan_account_inf_interest_rate= driver.findElement(locator(Vprop.getProperty("loan_account_inf_interest_rate"))).getText();
						String loan_account_inf_loan_date= driver.findElement(locator(Vprop.getProperty("loan_account_inf_loan_date"))).getText();
						
						String loan_account_inf_collateral_type= driver.findElement(locator(Vprop.getProperty("loan_account_inf_collateral_type"))).getText();
						String loan_account_inf_loan_frequency= driver.findElement(locator(Vprop.getProperty("loan_account_inf_loan_frequency"))).getText();
					
						String loan_account_inf_origination= driver.findElement(locator(Vprop.getProperty("loan_account_inf_origination"))).getText();
						String loan_account_inf_available_credit= driver.findElement(locator(Vprop.getProperty("loan_account_inf_available_credit"))).getText();
						
						String cust_underwriting_veritec_tran_nbr= driver.findElement(locator(Vprop.getProperty("cust_underwriting_veritec_tran_nbr"))).getText();
						/*String cust_underwriting_mla_status= driver.findElement(locator(Vprop.getProperty("cust_underwriting_mla_status"))).getText();
						String cust_underwriting_ofac_status= driver.findElement(locator(Vprop.getProperty("cust_underwriting_ofac_status"))).getText();
						String cust_promotion_campaign_name= driver.findElement(locator(Vprop.getProperty("cust_promotion_campaign_name"))).getText();
						String cust_promotion_coupon_code= "null";
						cust_promotion_coupon_code= driver.findElement(locator(Vprop.getProperty("cust_promotion_coupon_code"))).getText();*/
//Loan paid to date summary
						String loan_paid_summary_principal_paid_date= driver.findElement(locator(Vprop.getProperty("loan_paid_summary_principal_paid_date"))).getText();
						String loan_paid_summary_fee_paid_date= driver.findElement(locator(Vprop.getProperty("loan_paid_summary_fee_paid_date"))).getText();
						String loan_paid_summary_return_paid_date= driver.findElement(locator(Vprop.getProperty("loan_paid_summary_return_paid_date"))).getText();
						String loan_paid_summary_late_paid_date= driver.findElement(locator(Vprop.getProperty("loan_paid_summary_late_paid_date"))).getText();
						//String loan_paid_summary_total_paid_amt= driver.findElement(locator(Vprop.getProperty("loan_paid_summary_total_paid_date"))).getText();
					...
					/*	String loc_history_transaction_test= driver.findElement(locator(Vprop.getProperty("loc_history_transaction"))).getText();
						String loc_history_tendertype_test= driver.findElement(locator(Vprop.getProperty("loc_history_tendertype"))).getText();
						String loc_history_Tran_Amt_test= driver.findElement(locator(Vprop.getProperty("loc_history_Tran_Amt"))).getText();
						String loc_history_adv_Amt_test= driver.findElement(locator(Vprop.getProperty("loc_history_adv_Amt"))).getText();
						String loc_history_Int_Amt_test= driver.findElement(locator(Vprop.getProperty("loc_history_Int_Amt"))).getText();
						String loc_history_Lien_Amt_test= driver.findElement(locator(Vprop.getProperty("loc_history_Lien_Amt"))).getText();
						String loc_history_LateFee_Amt_test= driver.findElement(locator(Vprop.getProperty("loc_history_LateFee_Amt"))).getText();*/
							...
							String loc_history_Stmt_Nbr_test= driver.findElement(By.xpath("//*[@id='statementsGeneratedTable']/tbody/tr["+m+"]/td[1]")).getText();
							  //String loc_history_Stmt_Nbr_test= driver.findElement(locator(Vprop.getProperty("loc_history_Stmt_Nbr"))).getText();
						...
						//String loc_history_Stmt_Nbr_test= driver.findElement(locator(Vprop.getProperty("loc_history_Stmt_Nbr"))).getText();
						/*String loc_history_Stmt_Date_test= driver.findElement(locator(Vprop.getProperty("loc_history_Stmt_Date"))).getText();
						String loc_history_Min_Payment_Amt_test= driver.findElement(locator(Vprop.getProperty("loc_history_Min_Payment_Amt"))).getText();
						String loc_history_Payment_Due_Date_test= driver.findElement(locator(Vprop.getProperty("loc_history_Payment_Due_Date"))).getText();
						String loc_history_New_Balance_test= driver.findElement(locator(Vprop.getProperty("loc_history_New_Balance"))).getText();
						String loc_history_Previous_Balance_test= driver.findElement(locator(Vprop.getProperty("loc_history_Previous_Balance"))).getText();
						String loc_history_Paid_Flag_test= driver.findElement(locator(Vprop.getProperty("loc_history_Paid_Flag"))).getText();
						String loc_history_Capitalization_Interest_test= driver.findElement(locator(Vprop.getProperty("loc_history_Capitalization_Interest"))).getText();
						String loc_history_Statement_Closing_Date_test= driver.findElement(locator(Vprop.getProperty("loc_history_Statement_Closing_Date"))).getText();*/
						
						String loan_status_inf_latest_payment_date= driver.findElement(locator(Vprop.getProperty("loan_status_inf_latest_payment_date"))).getText();
						String loan_account_inf_min_pay_amt= driver.findElement(locator(Vprop.getProperty("loan_account_inf_min_pay_amt"))).getText();
						String loan_paid_summary_total_paid_amt= driver.findElement(locator(Vprop.getProperty("loan_paid_summary_total_paid_amt"))).getText();
						String loan_paid_summary_repo_fee_paid=driver.findElement(locator(Vprop.getProperty("loan_paid_summary_repo_fee_paid"))).getText();
						
						//Loan Balance Summary
						String loan_balance_inf_Earned_and_unpaid_interest= driver.findElement(locator(Vprop.getProperty("loan_balance_inf_Earned_and_unpaid_interest"))).getText();
						String loan_balance_inf_Return_Fee_Due= driver.findElement(locator(Vprop.getProperty("loan_balance_inf_Return_Fee_Due"))).getText();
						String loan_balance_inf_Late_Fee_Due= driver.findElement(locator(Vprop.getProperty("loan_balance_inf_Late_Fee_Due"))).getText();
						String loan_balance_inf_Pay_Off_Amt= driver.findElement(locator(Vprop.getProperty("loan_balance_inf_Pay_Off_Amt"))).getText();
						String loan_balance_inf_Past_Due_Amt= driver.findElement(locator(Vprop.getProperty("loan_balance_inf_Past_Due_Amt"))).getText();
						String loan_balance_inf_Remaining_Current_Payment_Amount= driver.findElement(locator(Vprop.getProperty("loan_balance_inf_Remaining_Current_Payment_Amount"))).getText();
						String loan_balance_inf_Remaining_Min_Payment_Amount= driver.findElement(locator(Vprop.getProperty("loan_balance_inf_Remaining_Min_Payment_Amount"))).getText();
						String loan_balance_inf_Statement_Payment_Amount=driver.findElement(locator(Vprop.getProperty("loan_balance_inf_Statement_Payment_Amount"))).getText();
						String loan_balance_inf_Current_Principal_Balance=driver.findElement(locator(Vprop.getProperty("loan_balance_inf_Current_Principal_Balance"))).getText();
						
						//cust documetn details
/*						String cust_doc_total_amount= driver.findElement(locator(Vprop.getProperty("cust_doc_total_amount"))).getText();
						String cust_doc_adv_amount= driver.findElement(locator(Vprop.getProperty("cust_doc_adv_amount"))).getText();
						String cust_doc_adv_fee= driver.findElement(locator(Vprop.getProperty("cust_doc_adv_fee"))).getText();
						String cust_doc_nsf_amount= driver.findElement(locator(Vprop.getProperty("cust_doc_nsf_amount"))).getText();
						String cust_doc_wo_amount= driver.findElement(locator(Vprop.getProperty("cust_doc_wo_amount"))).getText();
						String cust_doc_interest_fee= driver.findElement(locator(Vprop.getProperty("cust_doc_interest_fee"))).getText();
						String cust_doc_origination_fee= driver.findElement(locator(Vprop.getProperty("cust_doc_origination_fee"))).getText();
						String cust_doc_credit_or_verif_fee= driver.findElement(locator(Vprop.getProperty("cust_doc_credit_or_verif_fee"))).getText();
						String cust_doc_epp_fee= driver.findElement(locator(Vprop.getProperty("cust_doc_epp_fee"))).getText();*/
						...
						//To read from application       
						       ach_history_ach_type= driver.findElement(locator(Vprop.getProperty("ach_history_ach_type"))).getText();
								ach_history_ach_transaction= driver.findElement(locator(Vprop.getProperty("ach_history_ach_transaction"))).getText();
								ach_history_ach_effective_date= driver.findElement(By.xpath("//*[@id='achHistoryTable']/tbody/tr[2]/td[4]")).getText();
								ach_history_ach_status= driver.findElement(locator(Vprop.getProperty("ach_history_ach_status"))).getText();
								ach_history_ach_amt= driver.findElement(locator(Vprop.getProperty("ach_history_ach_amt"))).getText();
								ach_history_ach_ABA_code= driver.findElement(locator(Vprop.getProperty("ach_history_ach_ABA_code"))).getText();
								ach_history_ach_check_acc_no= driver.findElement(locator(Vprop.getProperty("ach_history_ach_check_acc_no"))).getText();
					      }
