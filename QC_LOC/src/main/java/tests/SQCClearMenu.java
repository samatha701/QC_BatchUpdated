...
public class SQCClearMenu extends QCStore {
	public static void clearMenu(String SSN,String AppURL) throws InterruptedException
	{
			...
			{		
		       ...
		       Thread.sleep(4000);
			    ...
			    /*String loan_nbr= driver.findElement(locator(Sprop.getProperty("loan_nbr"))).getText();
				test.log(LogStatus.PASS, "Loan Number is" + loan_nbr);*/
				  ...
				  if(ProductID.equals(Sprop.getProperty("TLP")))
					 {
					  driver.findElement(locator(Sprop.getProperty("clear_go"))).click();				   
					   ...
					   driver.switchTo().defaultContent();
						...
						if(ESign_CollateralType.equalsIgnoreCase("CHECK"))
						{
							...
							driver.findElement(By.linkText("Clear")).click();
							 ...
							 driver.switchTo().frame("mainFrame");
							 driver.switchTo().frame("main");
							 driver.findElement(locator(Sprop.getProperty("deposite_menu_loannbr"))).sendKeys(loan_nbr);
