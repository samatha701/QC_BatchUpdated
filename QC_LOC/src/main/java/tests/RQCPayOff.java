...
public class RQCPayOff extends QCStore
{

	public static void payoff(String SSN,String AppURL)
	{
		int i;
		for(i=0;i<3;i++)
		{
	...
	try{
			...
			{		
				...
				if(SSN.equals(RegSSN))
				{
					...
					test.log(LogStatus.PASS, "<FONT color=green style=Arial> PayOff transaction is successfull");
					Thread.sleep(1000);
					driver.close();
					Thread.sleep(2000);
					}
...
break;
					...
					test.log(LogStatus.INFO, "Payoff process is initiated again due to Application sync issue");
