...
public class VQCAgeStoreDueDate extends QCStore{
									  ...
									  //  Thread.sleep(2000);
										...
										for (String winHandle : driver.getWindowHandles()) {
											...
											if(!mainwindow.equalsIgnoreCase(winHandle)) {
												...
												System.out.println(loan_nbr);
												test.log(LogStatus.PASS, "Loan Number is" + loan_nbr);
												
												NextDueDate = driver.findElement(locator(Vprop.getProperty("csr_due_date1"))).getText();
