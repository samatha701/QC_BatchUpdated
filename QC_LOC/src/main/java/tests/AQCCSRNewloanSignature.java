...
public class AQCCSRNewloanSignature extends QCStore{
...
public static void LOC() throws InterruptedException
{
	...
	test.log(LogStatus.PASS, "Clicked on loan button");
		...
		{
			Thread.sleep(1000);
			String Loanamount=driver.findElement(By.xpath("//*[@id='errorMessage']/form[1]/table[1]/tbody/tr[2]/td/table/tbody/tr[3]/td/table/tbody/tr[7]/td[2]/input")).getAttribute("value");
			                                               
			driver.findElement(By.name("advanceRequestBean.disbAmtFirst")).sendKeys(Loanamount);
			
			test.log(LogStatus.PASS, "Disb amount enterd  as "+Loanamount);
