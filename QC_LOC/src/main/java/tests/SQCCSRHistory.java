...
public class SQCCSRHistory extends QCStore{
	...
	public static void history(String SSN,String AppURL)
	{
		...
		//String FileName= Sprop.getProperty("QCStore_NewLoan_file_name");
		
		//ExcelNew TestData = new ExcelNew(System.getProperty("user.dir")+Sprop.getProperty("QCStore_NewLoan_Test_data_sheet_path")+FileName+".xls");  		 
...
System.out.println(columnname+"_TxnHistory_FieldValue");
			   ...
			   String min_pay_amt=TestData.getCellData(sheetName_calc,columnname+"_TxnHistory_FieldValue",15);
			    ...
			    //Details values   
			       ...
			       loc_history_Capitalization_Interest=TestData.getCellData(sheetName_calc,columnname+"_Statement_FieldValue",7);
			       loc_history_Statement_Closing_Date=TestData.getCellData(sheetName_calc,columnname+"_Statement_FieldValue",8);
	 ...
	 //ACH collateral details from sheet
			 ...
			 //Validations
						...
						/*String cust_bank_inf_accout_type= driver.findElement(locator(Sprop.getProperty("cust_bank_inf_accout_type"))).getText();
						String cust_bank_inf_ABA_nbr= driver.findElement(locator(Sprop.getProperty("cust_bank_inf_ABA_nbr"))).getText();
						String cust_bank_inf_account_nbr= driver.findElement(locator(Sprop.getProperty("cust_bank_inf_account_nbr"))).getText();
						String cust_bank_inf_check_nbr= driver.findElement(locator(Sprop.getProperty("cust_bank_inf_check_nbr"))).getText();
						String cust_bank_inf_account_status= driver.findElement(locator(Sprop.getProperty("cust_bank_inf_account_status"))).getText();
						String cust_bank_inf_bank_name= driver.findElement(locator(Sprop.getProperty("cust_bank_inf_bank_name"))).getText();*/
					...
					/*	String loan_balance_inf_principal_bal= driver.findElement(locator(Sprop.getProperty("loan_balance_inf_principal_bal"))).getText();
						String loan_balance_inf_fee_due= driver.findElement(locator(Sprop.getProperty("loan_balance_inf_fee_due"))).getText();
						...
						/*String cust_underwriting_mla_status= driver.findElement(locator(Sprop.getProperty("cust_underwriting_mla_status"))).getText();
						String cust_underwriting_ofac_status= driver.findElement(locator(Sprop.getProperty("cust_underwriting_ofac_status"))).getText();
						String cust_promotion_campaign_name= driver.findElement(locator(Sprop.getProperty("cust_promotion_campaign_name"))).getText();
						String cust_promotion_coupon_code= "null";
						cust_promotion_coupon_code= driver.findElement(locator(Sprop.getProperty("cust_promotion_coupon_code"))).getText();*/
//Loan paid to date summary
						...
						//String loan_paid_summary_total_paid_amt= driver.findElement(locator(Sprop.getProperty("loan_paid_summary_total_paid_date"))).getText();

					
						String loc_history_transaction_test= driver.findElement(locator(Sprop.getProperty("loc_history_transaction"))).getText();
						String loc_history_tendertype_test= driver.findElement(locator(Sprop.getProperty("loc_history_tendertype"))).getText();
						String loc_history_Tran_Amt_test= driver.findElement(locator(Sprop.getProperty("loc_history_Tran_Amt"))).getText();
						String loc_history_adv_Amt_test= driver.findElement(locator(Sprop.getProperty("loc_history_adv_Amt"))).getText();
						String loc_history_Int_Amt_test= driver.findElement(locator(Sprop.getProperty("loc_history_Int_Amt"))).getText();
						String loc_history_Lien_Amt_test= driver.findElement(locator(Sprop.getProperty("loc_history_Lien_Amt"))).getText();
						String loc_history_LateFee_Amt_test= driver.findElement(locator(Sprop.getProperty("loc_history_LateFee_Amt"))).getText();
						
						String loc_history_Stmt_Nbr_test= driver.findElement(locator(Sprop.getProperty("loc_history_Stmt_Nbr"))).getText();
						String loc_history_Stmt_Date_test= driver.findElement(locator(Sprop.getProperty("loc_history_Stmt_Date"))).getText();
						String loc_history_Min_Payment_Amt_test= driver.findElement(locator(Sprop.getProperty("loc_history_Min_Payment_Amt"))).getText();
						String loc_history_Payment_Due_Date_test= driver.findElement(locator(Sprop.getProperty("loc_history_Payment_Due_Date"))).getText();
						String loc_history_New_Balance_test= driver.findElement(locator(Sprop.getProperty("loc_history_New_Balance"))).getText();
						String loc_history_Previous_Balance_test= driver.findElement(locator(Sprop.getProperty("loc_history_Previous_Balance"))).getText();
						String loc_history_Paid_Flag_test= driver.findElement(locator(Sprop.getProperty("loc_history_Paid_Flag"))).getText();
						String loc_history_Capitalization_Interest_test= driver.findElement(locator(Sprop.getProperty("loc_history_Capitalization_Interest"))).getText();
						String loc_history_Statement_Closing_Date_test= driver.findElement(locator(Sprop.getProperty("loc_history_Statement_Closing_Date"))).getText();
...
/*						String cust_doc_total_amount= driver.findElement(locator(Sprop.getProperty("cust_doc_total_amount"))).getText();
						String cust_doc_adv_amount= driver.findElement(locator(Sprop.getProperty("cust_doc_adv_amount"))).getText();
						String cust_doc_adv_fee= driver.findElement(locator(Sprop.getProperty("cust_doc_adv_fee"))).getText();
						String cust_doc_nsf_amount= driver.findElement(locator(Sprop.getProperty("cust_doc_nsf_amount"))).getText();
						String cust_doc_wo_amount= driver.findElement(locator(Sprop.getProperty("cust_doc_wo_amount"))).getText();
						String cust_doc_interest_fee= driver.findElement(locator(Sprop.getProperty("cust_doc_interest_fee"))).getText();
						String cust_doc_origination_fee= driver.findElement(locator(Sprop.getProperty("cust_doc_origination_fee"))).getText();
						String cust_doc_credit_or_verif_fee= driver.findElement(locator(Sprop.getProperty("cust_doc_credit_or_verif_fee"))).getText();
						String cust_doc_epp_fee= driver.findElement(locator(Sprop.getProperty("cust_doc_epp_fee"))).getText();*/
