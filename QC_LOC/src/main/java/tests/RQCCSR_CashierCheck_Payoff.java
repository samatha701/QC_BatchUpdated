...
public class RQCCSR_CashierCheck_Payoff extends QCStore
{

	public static void cashiercheckpayoff(String SSN,String AppURL)
	{
		int i;
		for(i=0;i<3;i++)
		{
	...
	try{
			...
			{		
				...
				if(SSN.equals(RegSSN))
				{
					...
					test.log(LogStatus.PASS, "CC_MO_Nbr is :"+CC_MO_Nbr);
					Thread.sleep(2000);
					...
					test.log(LogStatus.PASS, "<FONT color=green style=Arial> PayOff transaction is successfully");
					Thread.sleep(1000);
					driver.close();
					Thread.sleep(1000);
					}
