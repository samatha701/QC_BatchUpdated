...
public class VQCRefinance extends QCStore
{
				...
				if(SSN.equals(RegSSN))
				{
					 ...
					 String Bank_ChkgAcctNbr = TestData.getCellData(sheetName,"Bank_ChkgAcctNbr",row);
						...
						String Esign_Password = TestData.getCellData(sheetName,"ESign_Password",row);
								...
								Thread.sleep(3000);
								test.log(LogStatus.INFO,"RefinanceStepUp  process has started");
								 ...
								 for(String winHandle : driver.getWindowHandles())
									{
									 if(!mainWindow.equalsIgnoreCase(winHandle))
									 {
										...
										// Thread.sleep(5000);
										 driver.findElement(By.name("transactionDataBean.paymentAmt")).sendKeys(Keys.chord(Keys.BACK_SPACE, Keys.BACK_SPACE,Keys.BACK_SPACE,Keys.BACK_SPACE)+pbalstr);
										 //("^a"+pbalstr);
										...
										//String stpamt=driver.findElement(By.name("transactionDataBean.stepDownAmt")).getText();
										// test.log(LogStatus.PASS, "Step Down amount is "+stpamt);
										 
										// if(pbalstr.equals(stpamt))
										 {
											 test.log(LogStatus.PASS, "Steup amount condition satisfied ");
											...
											Thread.sleep(2000);
											 ...
											 //transactionDataBean.preference
											 ...
											 test.log(LogStatus.PASS, "Tender type selected as "+ESign_DisbType);
											 
											 //driver.findElement(By.name("transactionDataBean.tenderTypeFirst")).sendKeys(ESign_DisbType);
											 //driver.findElement(By.xpath(" //*[@id='disbursementType']/td[2]/select")).sendKeys(ESign_DisbType);
											 //test.log(LogStatus.PASS, "Tender type selected as "+ESign_DisbType);
											 
											 driver.findElement(By.name("transactionDataBean.tenderAmtFirst")).sendKeys(pbalstr);
											 test.log(LogStatus.PASS, "Tender amount is entered as  "+pbalstr);
											 ...
											 //For Rebate
											//String rebate= driver.findElement(By.xpath("transactionDataBean.rebate")).getText();
											String rebate= driver.findElement(By.xpath("/html/body/form[1]/table[2]/tbody/tr[2]/td/table/tbody/tr[1]/td/table/tbody/tr[5]/td[2]/table/tbody/tr[5]/td[2]/input")).getText();
											...
											driver.findElement(By.xpath(" /html/body/form[1]/table[2]/tbody/tr[2]/td/table/tbody/tr[3]/td/table/tbody/tr/td/input[5]")).click();
											 ...
											 driver.findElement(locator(Vprop.getProperty("refinance_yes_button"))).click();
...
break;
	...
	private static String StringOf(double pbalInt) {
