...
public class RQCCSR_LOCClosure extends QCStore
{

	public static void locclosure(String SSN,String AppURL)
	{
		int i;
		for(i=0;i<3;i++)
		{
	...
	try{
			int lastrow=TestData.getLastRow("LOC_Closure");
			String sheetName="LOC_Closure";
			...
			{		
				...
				if(SSN.equals(RegSSN))
				{
					...
					Thread.sleep(3000);
					test.log(LogStatus.INFO,"LOC Closure started");
					...
					driver.findElement(By.name("close uloc")).click();
					test.log(LogStatus.PASS, "Clicked on Closed ULOC");
					...
					test.log(LogStatus.PASS, "<FONT color=green style=Arial> LOC Closure is successfull");
					}
...
break;
	...
	public static void paymentTwice(String SSN,String AppURL)
	{
		int i;
		for(i=0;i<3;i++)
		{
