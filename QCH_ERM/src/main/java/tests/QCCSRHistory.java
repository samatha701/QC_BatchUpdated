...
System.out.println(columnname+"_TxnHistory_FieldValue");
			   ...
			   //    String collateral_type=TestData.getCellData(sheetName_calc,columnname+"_TxnHistory_FieldValue",16);
			      ...
			      // String credot_or_verification_fee=TestData.getCellData(sheetName_calc,columnname+"_TxnHistory_FieldValue",18);
			       ...
			       String promotion_Disc=TestData.getCellData(sheetName_calc,columnname+"_TxnHistory_FieldValue",34);
			       String loan_balance_inf_Verification_fee_due_sheet=TestData.getCellData(sheetName_calc,columnname+"_TxnHistory_FieldValue",35);
			       String loan_paid_summary_verification_fee_paid_sheet=TestData.getCellData(sheetName_calc,columnname+"_TxnHistory_FieldValue",36);
			       ...
			       String cust_doc_Orig_fee_test=TestData.getCellData(sheetName_calc,columnname+"_Detail_FieldValue",11);
			       String cust_doc_Verification_Fee_test=TestData.getCellData(sheetName_calc,columnname+"_Detail_FieldValue",12);
	 //ACH collateral details from sheet
			 ...
			 //Validations
						...
						String p_name[]=loan_account_inf_product_name.split(":");
						loan_account_inf_product_name=p_name[1];
						...
						String loan_account_inf_inst_amt= driver.findElement(locator(Aprop.getProperty("loan_account_inf_loan_date"))).getText();
						String loan_account_inf_no_of_installments= driver.findElement(locator(Aprop.getProperty("loan_account_inf_max_term_date"))).getText();
						...
						String cust_promotion_coupon_code= driver.findElement(locator(Aprop.getProperty("cust_promotion_coupon_code"))).getText();
						//String cust_promotion_coupon_Disc= driver.findElement(locator(Aprop.getProperty("cust_promotion_coupon_Disc"))).getText();
//Loan paid to date summary
						...
						String loan_balance_inf_past_due_amt= driver.findElement(locator(Aprop.getProperty("loan_balance_inf_past_due_amt"))).getText();
						String loan_balance_inf_Verification_fee_due= driver.findElement(locator(Aprop.getProperty("loan_balance_inf_Verification_fee_due"))).getText();
						String loan_paid_summary_verification_fee_paid= driver.findElement(locator(Aprop.getProperty("loan_paid_summary_verification_fee_paid"))).getText();
					...
					/*String cust_transaction_date= driver.findElement(locator(Aprop.getProperty("cust_transaction_date"))).getText();
					...
					cust_transaction_date=cust_transaction_date_array[0];*/
					    ...
					    String cust_doc_Orig_fee=  driver.findElement(By.xpath("//*[@id='transactionDetailsTable']/tbody/tr["+n+"]/td[19]/font")).getText();
					    String cust_doc_Verification_Fee=  driver.findElement(By.xpath("//*[@id='transactionDetailsTable']/tbody/tr["+n+"]/td[20]/font")).getText();
					    String loan_paid_summary_total_paid_amt= driver.findElement(locator(Aprop.getProperty("loan_paid_summary_total_paid_amt"))).getText();
						...
						if(cust_inf_customer_name.toLowerCase().trim().trim().contains(customer_name.toLowerCase()))
						{
							test.log(LogStatus.PASS, "Customer Name->Expected value:"+customer_name +"; == Actual value:"+cust_inf_customer_name);
						}
						else
						{
							test.log(LogStatus.FAIL, "Customer Name->Expected value:"+customer_name.toLowerCase() +"; != Actual value:"+cust_inf_customer_name.toLowerCase());
							...
							{
								test.log(LogStatus.FAIL, "SSN->Expected value:"+SSNverify +"; != Actual value:"+cust_inf_customer_SSN);
							...
							{
								test.log(LogStatus.FAIL, "Bank_ABARoutingNbr->Expected value:"+Bank_ABARoutingNbr +"; != Actual value:"+cust_bank_inf_ABA_nbr);
							...
							{
								test.log(LogStatus.FAIL, "Bank_ChkgAcctNbr->Expected value:"+Bank_ChkgAcctNbr +"; != Actual value:"+cust_bank_inf_account_nbr);
							...
							{
								test.log(LogStatus.FAIL, "primary_source_of_income->Expected value:"+primary_source_of_income +"; != Actual value:"+employer_inf_source_of_income);
							...
							{
								test.log(LogStatus.FAIL, "loan_status->Expected value:"+loan_status +"; != Actual value:"+loan_status_inf_loan_status);
							...
							{
								test.log(LogStatus.FAIL, "check_status->Expected value:"+check_status +"; != Actual value:"+loan_status_inf_checkstatus);
							...
							/*if(finance_charge.equalsIgnoreCase(loan_account_inf_no_of_installments))
							{
								test.log(LogStatus.PASS, "finance_charge->Expected value:"+finance_charge +"; == Actual value:"+loan_account_inf_no_of_installments);
							}
							else
							{
								test.log(LogStatus.FAIL, "finance_charge->Expected value:"+finance_charge +"; != Actual value:"+loan_account_inf_no_of_installments);
							...
							{
								test.log(LogStatus.FAIL, "Instalment amount->Expected value:"+loan_account_inf_inst_amt_test +"; != Actual value:"+loan_account_inf_inst_amt);
							...
							{
								test.log(LogStatus.FAIL, "apr->Expected value:"+apr +"; != Actual value:"+loan_account_inf_APR);
							...
							{
								test.log(LogStatus.FAIL, "courtesy_consent_status->Expected value:"+courtesy_consent_status +"; != Actual value:"+courtesy_inf_courtesy_status);
							...
							{
								test.log(LogStatus.FAIL, "principal_balance->Expected value:"+principal_balance +"; != Actual value:"+loan_balance_inf_principal_bal);
							...
							{
								test.log(LogStatus.FAIL, "Earned and unpaid interest->Expected value:"+fee_due +"; != Actual value:"+loan_balance_inf_fee_due);
							...
							{
								test.log(LogStatus.FAIL, "pay_off_amount->Expected value:"+pay_off_amount +"; != Actual value:"+loan_balance_inf_pay_off_amt);
							...
							{
								test.log(LogStatus.FAIL, "past due amount->Expected value:"+loan_balance_inf_past_due_amt_test +"; != Actual value:"+loan_balance_inf_past_due_amt);
							...
							{
								test.log(LogStatus.PASS, "Interest Paid to date->Expected value:"+fee_paid_date +"; == Actual value:"+loan_paid_summary_fee_paid_date);
							}
							else
							{
								test.log(LogStatus.FAIL, "Interest Paid to date->Expected value:"+fee_paid_date +"; != Actual value:"+loan_paid_summary_fee_paid_date);
					...
					if(loan_balance_inf_Verification_fee_due_sheet.equalsIgnoreCase(loan_balance_inf_Verification_fee_due))
					{
						test.log(LogStatus.PASS, "Verification_fee_due->Expected value:"+loan_balance_inf_Verification_fee_due_sheet +"; == Actual value:"+loan_balance_inf_Verification_fee_due);
					}
					else
					{
						test.log(LogStatus.FAIL, "Verification_fee_due->Expected value:"+loan_balance_inf_Verification_fee_due_sheet +"; != Actual value:"+loan_balance_inf_Verification_fee_due);

					} 
					
					if(loan_paid_summary_verification_fee_paid_sheet.equalsIgnoreCase(loan_paid_summary_verification_fee_paid))
					{
						test.log(LogStatus.PASS, "Verification_fee_paid->Expected value:"+loan_paid_summary_verification_fee_paid_sheet +"; == Actual value:"+loan_paid_summary_verification_fee_paid);
					}
					else
					{
						test.log(LogStatus.FAIL, "Verification_fee_paid->Expected value:"+loan_paid_summary_verification_fee_paid_sheet +"; != Actual value:"+loan_paid_summary_verification_fee_paid);
							...
							{
								test.log(LogStatus.FAIL, "campaign_name->Expected value:"+campaign_name +"; != Actual value:"+cust_promotion_campaign_name);

							}
							if(promotion_code.trim().toLowerCase().equalsIgnoreCase(cust_promotion_coupon_code.trim().toLowerCase()))
							{
								test.log(LogStatus.PASS, "promotion_code->Expected value:"+promotion_code +"; == Actual value:"+cust_promotion_coupon_code);
							}
							else
							{
								test.log(LogStatus.FAIL, "promotion_code->Expected value:"+promotion_code +"; != Actual value:"+cust_promotion_coupon_code);

							}
							/*if(promotion_Disc.equalsIgnoreCase(cust_promotion_coupon_Disc))
							{
								test.log(LogStatus.PASS, "promotion_Disc->Expected value:"+promotion_Disc +"; == Actual value:"+cust_promotion_coupon_Disc);
							}
							else
							{
								test.log(LogStatus.FAIL, "promotion_Disc->Expected value:"+promotion_Disc +"; != Actual value:"+cust_promotion_coupon_Disc);

							}*/
							if(loan_account_inf_product_name.toLowerCase().trim().equalsIgnoreCase(product_name.toLowerCase().trim()))
							{
							...
							if(tran_date_sheet.isEmpty())
							{
									...
									{
										test.log(LogStatus.FAIL, "transaction date->Expected value:"+cust_transaction_date_test +"; != Actual value:"+cust_transaction_date);
							...
							else
							{
								...
								{
									test.log(LogStatus.FAIL, "transaction date->Expected value:"+tran_date_sheet +"; != Actual value:"+cust_transaction_date);
	
								}
							}
							if(cust_tran_test.toLowerCase().trim().equalsIgnoreCase(cust_tran.toLowerCase().trim()))
							{
								test.log(LogStatus.PASS, "Transaction->Expected value:"+cust_tran_test +"; == Actual value:"+cust_tran);
							}
							else
							{
								test.log(LogStatus.FAIL, "Transaction->Expected value:"+cust_tran_test +"; != Actual value:"+cust_tran);
							...
							{
								test.log(LogStatus.FAIL, "total_amount->Expected value:"+cust_doc_total_amount_test +"; != Actual value:"+cust_doc_total_amount);

							}
							if(cust_doc_tender_type_test.toLowerCase().trim().equalsIgnoreCase(cust_doc_tender_type.toLowerCase().trim())||"CHK".toLowerCase().trim().equalsIgnoreCase(cust_doc_tender_type.toLowerCase().trim()))
							{
								test.log(LogStatus.PASS, "Tender type->Expected value:"+cust_doc_tender_type_test +"; == Actual value:"+cust_doc_tender_type);
							}
							else
							{
								test.log(LogStatus.FAIL, "Tender type->Expected value:"+cust_doc_tender_type_test +"; != Actual value:"+cust_doc_tender_type);
							...
							{
								test.log(LogStatus.FAIL, "Inst#->Expected value:"+cust_doc_inst_test +"; != Actual value:"+cust_doc_inst);
							...
							{
								test.log(LogStatus.FAIL, "Adv amount->Expected value:"+cust_doc_adv_amount_test +"; != Actual value:"+cust_doc_adv_amount);
							...
							{
								test.log(LogStatus.FAIL, "Interest->Expected value:"+cust_doc_interest_test +"; != Actual value:"+cust_doc_interest);
							...
							{
								test.log(LogStatus.FAIL, "New_balance->Expected value:"+cust_doc_new_balance_test +"; != Actual value:"+cust_doc_new_balance);
							...
							{
								test.log(LogStatus.FAIL, "Promotion/Coupon Amt->Expected value:"+cust_doc_PromotionCoupon_Amt_test +"; != Actual value:"+cust_doc_PromotionCoupon_Amt);

							}
							
							if(cust_doc_Orig_fee_test.equalsIgnoreCase(cust_doc_Orig_fee))
							{
								test.log(LogStatus.PASS, "OrigFee/AcquisitionFee->Expected value:"+cust_doc_Orig_fee_test +"; == Actual value:"+cust_doc_Orig_fee);
							}
							else
							{
								test.log(LogStatus.FAIL, "OrigFee/AcquisitionFee->Expected value:"+cust_doc_Orig_fee_test +"; != Actual value:"+cust_doc_Orig_fee);

							}
							
							if(cust_doc_Verification_Fee_test.equalsIgnoreCase(cust_doc_Verification_Fee))
							{
								test.log(LogStatus.PASS, "Verification_Fee->Expected value:"+cust_doc_Verification_Fee_test +"; == Actual value:"+cust_doc_Verification_Fee);
							}
							else
							{
								test.log(LogStatus.FAIL, "Verification_Fee->Expected value:"+cust_doc_Verification_Fee_test +"; != Actual value:"+cust_doc_Verification_Fee);
							...
							if(ESign_CollateralType.equals("ACH"))
							{
								...
								if(ACH_status.toLowerCase().trim().equalsIgnoreCase(ach_history_ach_status.toLowerCase().trim()))
								{
								...
								{
									test.log(LogStatus.FAIL, "ACH_ABA_code->Expected value:"+ACH_ABA_code +"; != Actual value:"+ach_history_ach_ABA_code);
