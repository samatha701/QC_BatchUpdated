...
public class AQCAdminEncryption extends QCStore
{
	...
	driver.findElement(By.name("trancd")).sendKeys("EOD Encryption-EOD");
	test.log(LogStatus.PASS, "Trancd selected as:EOD Encryption-EOD");
