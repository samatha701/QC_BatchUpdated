...
public class ILP_SecondPayment extends QCStore{
			...
			{	
				...
				String paymentamount = Float.toString(PayOff);
				  ...
				  if(Scenario.equalsIgnoreCase("Payment")){
					...
					driver.findElement(By.name("requestBean.siilBean.tenderAmtFirst")).sendKeys(PaymentAmount2);
					test.log(LogStatus.PASS, "TenderAmount is :"+PaymentAmount2);	
