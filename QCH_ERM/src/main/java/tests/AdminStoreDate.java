...
public class AdminStoreDate extends QCStore
{
	static String startdate;

	public static void Startdate_Update(String SSN,String AppURL) throws InterruptedException, ParseException
	{
			...
			test.log(LogStatus.PASS, "Enterd year as"+Date3);
				...
				test.log(LogStatus.PASS, "Clicked on OK button for Sucess");
