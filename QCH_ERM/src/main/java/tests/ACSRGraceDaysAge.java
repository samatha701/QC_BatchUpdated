...
public class ACSRGraceDaysAge extends QCStore{
	...
	/*   store date+grace days */
	public static  void Again_GraceDays(String SSN,String AppURL) throws Exception{
		...
		{	
			...
			{
				//String GraceDays="10";
				String GraceDays=TestData.getCellData(sheetName,"Again_GraceDays",row);
				test.log(LogStatus.INFO, "******Performing age the store to grace days ******");
				driver.switchTo().frame("bottom");
				String Str_date=driver.findElement(By.xpath("/html/body/blink/table/tbody/tr/td[4]")).getText();			
				test.log(LogStatus.PASS, "Current store date is "+Str_date);
