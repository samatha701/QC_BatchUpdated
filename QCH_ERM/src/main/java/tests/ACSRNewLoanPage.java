...
public class ACSRNewLoanPage extends QCStore{
	...
	public static void PDL() throws InterruptedException
	{
		...
		Thread.sleep(3000);
		driver.findElement(By.id("LoanButtonId")).isEnabled();
		driver.findElement(By.xpath("//*[@id='LoanButtonId']")).click();
		test.log(LogStatus.PASS, "Clicked on NewLoan Button");
		...
		if (AllowPromotion.equals("Yes")) {
			...
			driver.findElement(locator(Aprop.getProperty("csr_new_loan_promotions_btn"))).click();
				...
				/*	if (AllowPromotion.equals("Yes")) {
						...
						for (String winHandle1 : driver.getWindowHandles()) {
							...
							if (!main_window.equalsIgnoreCase(winHandle1)) {
								...
								driver.findElement(By.xpath("/html/body/form/table/tbody/tr/td/table/tbody/tr/td/table/tbody/tr[2]/td[2]/table/tbody/tr[2]/td/table/tbody/tr[1]/td/table/tbody/tr[2]/td[1]/input")).click();
...
/*
			...
			test.log(LogStatus.PASS, "click on Yes button on popup ");
			driver.switchTo().defaultContent();
			driver.switchTo().frame("mainFrame");
			driver.switchTo().frame("main");
